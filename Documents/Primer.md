...
| $\ngtr$ | Mot Greater Than | Indicates that the expression to the left should not be larger than the expression to the right. |
...
Cubic equation is where the equation involves an exponent of 3.
