    ...
    : Form
{
    ...
    /// </summary>
    private readonly XmlSerializer vectorMapSerializer = new(typeof(VectorMap));

    /// <summary>
    /// The boundary item.
    /// </summary>
    private GraphicItem boundaryItem = new(Rectangle2D.Empty, new ShapeStyle(Brushes.Red, new Pen(Brushes.Plum)));
    ...
    /// The text measurer.
    /// </summary>
    private readonly WinFormsTextMeasurer textMeasurer = new();
    #endregion Fields
    ...
    private void EditorForm_Load(object sender, EventArgs e)
    {
        ...
        paletteToolStripItem1.PaletteControl.Palette = new Palette([
            Colors.Black,
            Colors.White,
            Colors.Red,
            Colors.Orange,
