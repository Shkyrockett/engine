    ...
    : TypeConverter
{
    ...
    public override object? ConvertTo(ITypeDescriptorContext? context, CultureInfo? culture, object? value, Type destinationType)
    {
        ...
        return value is not List<IGameElement> gameElements ? "-" : string.Join(", ", gameElements.Select(m => m.Name));
    }
    ...
    /// </summary>
    /// <seealso cref="TypeConverter.SimplePropertyDescriptor" />
        ...
        : SimplePropertyDescriptor
    {
        ...
        /// <param name="component">The component.</param>
        /// <param name="value">The value.</param>
        public override void SetValue(object? component, object? value) => GameElement.Name = value as string ?? string.Empty;
    }
}
