...
public static class Colorspaces
{
    ...
    public static bool ValidateRGBA(byte r, byte g, byte b, byte a)
        => Between(a, Numbers<double>.RGBMin, Numbers<double>.RGBMax)
        && Between(r, Numbers<double>.RGBMin, Numbers<double>.RGBMax)
        && Between(g, Numbers<double>.RGBMin, Numbers<double>.RGBMax)
        && Between(b, Numbers<double>.RGBMin, Numbers<double>.RGBMax);
    ...
    public static bool ValidateRGBAF(double r, double g, double b, double a)
        => Between(a, Floats<double>.PercentMin, Floats<double>.PercentMax)
        && Between(r, Floats<double>.PercentMin, Floats<double>.PercentMax)
        && Between(g, Floats<double>.PercentMin, Floats<double>.PercentMax)
        && Between(b, Floats<double>.PercentMin, Floats<double>.PercentMax);
    ...
    public static bool ValidateCMYKA(byte c, byte y, byte m, byte k, byte a)
        => Between(a, Numbers<double>.CMYKMin, Numbers<double>.CMYKMax)
        && Between(c, Numbers<double>.CMYKMin, Numbers<double>.CMYKMax)
        && Between(y, Numbers<double>.CMYKMin, Numbers<double>.CMYKMax)
        && Between(m, Numbers<double>.CMYKMin, Numbers<double>.CMYKMax)
        && Between(k, Numbers<double>.CMYKMin, Numbers<double>.CMYKMax);
    ...
    public static bool ValidateHSIA(double h, double s, double i, double a)
        => Between(a, Floats<double>.PercentMin, Floats<double>.PercentMax)
        && Between(h, Numbers<double>.HueMin, Numbers<double>.HueMax)
        && Between(s, Floats<double>.PercentMin, Floats<double>.PercentMax)
        && Between(i, Floats<double>.PercentMin, Floats<double>.PercentMax);
    ...
    public static bool ValidateHSLA(double h, double s, double l, double a)
        ...
        && Between(h, Numbers<double>.HueMin, Numbers<double>.HueMax)
        && Between(s, Floats<double>.PercentMin, Floats<double>.PercentMax)
        && Between(l, Floats<double>.PercentMin, Floats<double>.PercentMax);
    ...
    public static bool ValidateHSVA(double h, double s, double v, double a)
        ...
        && Between(h, Numbers<double>.HueMin, Numbers<double>.HueMax)
        && Between(s, Floats<double>.PercentMin, Floats<double>.PercentMax)
        && Between(v, Floats<double>.PercentMin, Floats<double>.PercentMax);
    ...
    public static bool ValidateYIQA(double y, double i, double q, double a)
        => Between(a, Floats<double>.PercentMin, Floats<double>.PercentMax)
        && Between(y, Floats<double>.PercentMin, Floats<double>.PercentMax)
        && Between(i, Floats<double>.YIQMinI, Floats<double>.YIQMaxI)
        && Between(q, Floats<double>.YIQMinQ, Floats<double>.YIQMaxQ);
    ...
    public static bool ValidateYUVA(double y, double u, double v, double a)
        => Between(a, Floats<double>.PercentMin, Floats<double>.PercentMax)
        && Between(y, Floats<double>.PercentMin, Floats<double>.PercentMax)
        && Between(u, Floats<double>.YUVMinU, Floats<double>.YUVMaxU)
        && Between(v, Floats<double>.YUVMinV, Floats<double>.YUVMaxV);
    ...
    public static (byte r, byte g, byte b, byte a) ClampRGBA(byte r, byte g, byte b, byte a)
        => (
        Operations.Clamp(a, Numbers<byte>.RGBMin, Numbers<byte>.RGBMax),
        Operations.Clamp(r, Numbers<byte>.RGBMin, Numbers<byte>.RGBMax),
        Operations.Clamp(g, Numbers<byte>.RGBMin, Numbers<byte>.RGBMax),
        Operations.Clamp(b, Numbers<byte>.RGBMin, Numbers<byte>.RGBMax)
        );
    ...
    public static (double r, double g, double b, double a) ClampRGBAF(double r, double g, double b, double a)
        => (
        Operations.Clamp(a, Floats<double>.PercentMin, Floats<double>.PercentMax),
        Operations.Clamp(r, Floats<double>.PercentMin, Floats<double>.PercentMax),
        Operations.Clamp(g, Floats<double>.PercentMin, Floats<double>.PercentMax),
        Operations.Clamp(b, Floats<double>.PercentMin, Floats<double>.PercentMax)
        );
    ...
    public static (byte c, byte y, byte m, byte k, byte a) ClampCMYKA(byte c, byte y, byte m, byte k, byte a)
        => (
        Operations.Clamp(a, Numbers<byte>.CMYKMin, Numbers<byte>.CMYKMax),
        Operations.Clamp(c, Numbers<byte>.CMYKMin, Numbers<byte>.CMYKMax),
        Operations.Clamp(y, Numbers<byte>.CMYKMin, Numbers<byte>.CMYKMax),
        Operations.Clamp(m, Numbers<byte>.CMYKMin, Numbers<byte>.CMYKMax),
        Operations.Clamp(k, Numbers<byte>.CMYKMin, Numbers<byte>.CMYKMax)
        );
    ...
    public static (double h, double s, double i, double a) ClampHSIA(double h, double s, double i, double a)
        => (
        Operations.Clamp(a, Floats<double>.PercentMin, Floats<double>.PercentMax),
        Operations.Clamp(h, Numbers<double>.HueMin, Numbers<double>.HueMax),
        Operations.Clamp(s, Floats<double>.PercentMin, Floats<double>.PercentMax),
        Operations.Clamp(i, Floats<double>.PercentMin, Floats<double>.PercentMax)
        );
    ...
    public static (double h, double s, double l, double a) ClampHSLA(double h, double s, double l, double a)
        ...
        Operations.Clamp(h, Numbers<double>.HueMin, Numbers<double>.HueMax),
        Operations.Clamp(s, Floats<double>.PercentMin, Floats<double>.PercentMax),
        Operations.Clamp(l, Floats<double>.PercentMin, Floats<double>.PercentMax)
        );
    ...
    public static (double h, double s, double v, double a) ClampHSVA(double h, double s, double v, double a)
        ...
        Operations.Clamp(h, Numbers<double>.HueMin, Numbers<double>.HueMax),
        Operations.Clamp(s, Floats<double>.PercentMin, Floats<double>.PercentMax),
        Operations.Clamp(v, Floats<double>.PercentMin, Floats<double>.PercentMax)
        );
    ...
    public static (double y, double i, double q, double a) ClampYIQA(double y, double i, double q, double a)
        => (
        Operations.Clamp(a, Floats<double>.PercentMin, Floats<double>.PercentMax),
        Operations.Clamp(y, Floats<double>.PercentMin, Floats<double>.PercentMax),
        Operations.Clamp(i, Floats<double>.YIQMinI, Floats<double>.YIQMaxI),
        Operations.Clamp(q, Floats<double>.YIQMinQ, Floats<double>.YIQMaxQ)
        );
    ...
    public static (double y, double u, double v, double a) ClampYUVA(double y, double u, double v, double a)
        ...
        Operations.Clamp(a, Floats<double>.PercentMin, Floats<double>.PercentMax),
        Operations.Clamp(y, Floats<double>.PercentMin, Floats<double>.PercentMax),
        Operations.Clamp(u, Floats<double>.YUVMinU, Floats<double>.YUVMaxU),
        Operations.Clamp(v, Floats<double>.YUVMinV, Floats<double>.YUVMaxV)
        );
    #endregion
    ...
    public static (double red, double green, double blue, double alpha) RGBAColorToRGBAFColor(byte red, byte green, byte blue, byte alpha)
    {
        ...
        var d = 1d / Numbers<double>.RGBMax;
        return (
            red: red * d,
            green: green * d,
            blue: blue * d,
    ...
    public static (byte red, byte green, byte blue, byte alpha) RGBAFColorToRGBAColor(double red, double green, double blue, double alpha)
    {
        ...
        var d = Numbers<double>.RGBMax + 0.5d;
        return (
            red: (byte)(red * d),
            green: (byte)(green * d),
            blue: (byte)(blue * d),
    ...
    public static (double red, double green, double blue, double alpha) HSLAColorToRGBAFColor(double hue, double saturation, double luminance, double alpha)
    {
        ...
        if (ValidateHSLA(hue, saturation, luminance, alpha) == true)
        {
            ...
            if (hue >= 0d && hue < (Numbers<double>.HueMax / 6d))
            {
                color = (c + m, x + m, m, alpha);
            }
            else if (hue >= (Numbers<double>.HueMax / 6d) && hue < (Numbers<double>.HueMax / 3d))
            {
                color = (x + m, c + m, m, alpha);
            }
            else if (hue < (Numbers<double>.HueMax / 3d) && hue < (Numbers<double>.HueMax / 2d))
            {
                color = (m, c + m, x + m, alpha);
            }
            else if (hue >= (Numbers<double>.HueMax / 2d) && hue < (2d * Numbers<double>.HueMax / 3d))
            {
                color = (m, x + m, c + m, alpha);
            }
            else if (hue >= (2d * Numbers<double>.HueMax / 3d) && hue < (5d * Numbers<double>.HueMax / 6d))
            {
                color = (x + m, m, c + m, alpha);
            }
            else if (hue >= (5d * Numbers<double>.HueMax / 6d) && hue < Numbers<double>.HueMax)
            {
