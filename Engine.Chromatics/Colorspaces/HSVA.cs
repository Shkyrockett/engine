    ...
    : IColor, IEquatable<HSVA>
{
    ...
    /// </returns>
    public readonly bool Equals([AllowNull] HSVA other) => Alpha == other.Alpha && Hue == other.Hue && Saturation == other.Saturation && Value == other.Value;
    ...
    /// </returns>
    public override readonly int GetHashCode() => HashCode.Combine(Alpha, Hue, Saturation, Value);
    ...
    /// https://www.cs.rit.edu/~ncs/color/t_convert.html
    /// </acknowledgment>
    public readonly (byte Red, byte Green, byte Blue, byte Alpha) ToRGBATuple() => Colorspaces.HSVAColorToRGBAColor(Hue, Saturation, Value, Alpha);
