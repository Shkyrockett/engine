    ...
    : IColor, IEquatable<YIQA>
{
    ...
    /// </summary>
    public static readonly YIQA Empty;
    ...
    /// </returns>
    public readonly bool Equals([AllowNull] YIQA other) => Alpha == other.Alpha && Y == other.Y && I == other.I && Q == other.Q;
    ...
    /// </returns>
    public override readonly int GetHashCode() => HashCode.Combine(Alpha, Y, I, Q);
    ...
    /// </returns>
    public readonly (byte Red, byte Green, byte Blue, byte Alpha) ToRGBATuple() => Colorspaces.RGBAFColorToRGBAColor(Colorspaces.YIQAColorToRGBAFColor(Y, I, Q, Alpha));
