    ...
    : IVector<Orientation3D>, IEquatable<Orientation3D>
{
    ...
    /// The empty
    /// </summary>
    public static readonly Orientation3D Empty = new(0d, 0d, 0d);

    /// <summary>
    /// The na n
    /// </summary>
    public static readonly Orientation3D NaN = new(double.NaN, double.NaN, double.NaN);
    #endregion
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly void Deconstructor(out double roll, out double pitch, out double yaw)
    {
        roll = Roll;
        pitch = Pitch;
        yaw = Yaw;
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public override readonly bool Equals([AllowNull] object obj) => obj is Orientation3D d && Equals(this, d);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly bool Equals([AllowNull] Orientation3D value) => (Roll == value.Roll) && (Pitch == value.Pitch) && (Yaw == value.Yaw);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Orientation3D FromValueTuple((double Roll, double Pitch, double Yaw) tuple) => new(tuple);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public override readonly int GetHashCode() => HashCode.Combine(Roll, Pitch, Yaw);
