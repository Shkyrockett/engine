    ...
    : IVector<Quaternion4D>
{
    ...
    /// </summary>
    public static readonly Quaternion4D Empty = new(0d, 0d, 0d, 0d);

    /// <summary>
    /// Represents a <see cref="Quaternion4D" /> that has <see cref="X" />, <see cref="Y" />, <see cref="Z" />, and <see cref="W" /> values set to zero.
    /// </summary>
    public static readonly Quaternion4D Zero = new(0d, 0d, 0d, 0d);

    /// <summary>
    /// Represents a <see cref="Quaternion4D" /> that has <see cref="X" />, <see cref="Y" />, <see cref="Z" />, and <see cref="W" /> values set to NaN.
    /// </summary>
    public static readonly Quaternion4D NaN = new(double.NaN, double.NaN, double.NaN, double.NaN);
    ...
    /// </summary>
    public static readonly Quaternion4D Identity = new(0d, 0d, 0d, 1d);
    #endregion
    ...
    public readonly double Normal => Measurements.QuaternionNormal(X, Y, Z, W);
    ...
    /// </value>
    [IgnoreDataMember, XmlIgnore, SoapIgnore]
    public readonly double LengthSquared => Measurements.QuaternionNormal(X, Y, Z, W);
    ...
    /// </value>
    [IgnoreDataMember, XmlIgnore, SoapIgnore]
    public readonly double Length => Measurements.QuaternionMagnitude(X, Y, Z, W);
    ...
    public readonly double Roll
    {
        ...
        get
        {
            ...
            if (Abs(test) > 0.499d) // singularitY at north and south pole
            {
                return Sign(test) * Floats<double>.Hau;
            }
    ...
    /// </value>
    [IgnoreDataMember, XmlIgnore, SoapIgnore]
    public readonly Vector3D XAxis
    {
        get
        {
            //var fTX = 2d * X;
    ...
    /// </value>
    [IgnoreDataMember, XmlIgnore, SoapIgnore]
    public readonly Vector3D YAxis
    {
        get
        {
            var fTX = 2d * X;
    ...
    /// </value>
    [IgnoreDataMember, XmlIgnore, SoapIgnore]
    public readonly Vector3D ZAxis
    {
        get
        {
            var fTX = 2d * X;
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static implicit operator Quaternion4D((double X, double Y, double Z, double W) tuple) => new(tuple);
    #endregion Operators
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public override bool Equals([AllowNull] object obj) => obj is Quaternion4D o && Equals(o);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly bool Equals(Quaternion4D value) => (X == value.X) && (Y == value.Y) && (Z == value.Z) && (W == value.W);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Quaternion4D FromValueTuple((double X, double Y, double Z, double W) tuple) => new(tuple);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly Quaternion4D ToQuaternion4D() => new(X, Y, Z, W);
    #endregion
