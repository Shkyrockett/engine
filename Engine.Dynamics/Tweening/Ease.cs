...
public static class Ease
{
    ...
    public static double ExpoOut(double t)
        => (Abs(t - 1d) < double.Epsilon) ? 1d : -Pow(2d, -10d * t) + 1d;
    ...
    public static double SineIn(double t, double b, double c, double d)
        => (-c * Cos(t / d * Floats<double>.Hau)) + c + b;
    ...
    public static double SineInOut(double t, double b, double c, double d)
        => ((t /= d * 0.5d) < 1d)
        ? (c * 0.5d * Sin(Floats<double>.Hau * t)) + b
        : (-c * 0.5d * (Cos(Floats<double>.Hau * --t) - 2d)) + b;
    ...
    public static double ElasticIn(double t)
        => Sin(13d * Floats<double>.Hau * t) * Pow(2d, 10d * (t - 1d));
    ...
    public static double ElasticOut(double t)
        => (Abs(t - 1d) < double.Epsilon) ? 1d : ((Sin(-13d * Floats<double>.Hau * (t + 1d)) * Pow(2d, -10d * t)) + 1d);
    ...
    public static double ElasticInOut(double t)
        => (t < 0.5d) ?
            (0.5d * Sin(13d * Floats<double>.Hau * (2d * t)) * Pow(2d, 10d * ((2d * t) - 1d))) :
            (0.5d * ((Sin(-13d * Floats<double>.Hau * ((2d * t) - 1 + 1d)) * Pow(2d, -10d * ((2d * t) - 1d))) + 2d));
