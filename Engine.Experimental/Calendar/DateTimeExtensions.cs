// <copyright file="DateTimeExtensions.cs" company="Shyrockett" >
...
public static class DateTimeExtensions
{
    ...
    public static DateTime AtMidday(this DateTime date)
        => new(date.Year, date.Month, date.Day, 12, 0, 0);
    ...
    /// <param name="weekday"></param>
    /// <returns></returns>
    public static DateTime LastInstanceWeekdayOfMonth(this DateTime date, int occurrence, DayOfWeek weekday)
        => LastDayOfMonth(date).NextDayOfWeek(weekday).AddDays(-(7 * occurrence));
}
