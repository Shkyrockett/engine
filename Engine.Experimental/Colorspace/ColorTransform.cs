    ...
    : IEquatable<ColorTransform>
{
    ...
    /// The identity.
    /// </summary>
    public static readonly ColorTransform Identity = new(1d, 1d, 1d, 1d, 0, 0, 0, 0);
    ...
    /// </returns>
    public override readonly bool Equals(object? obj) => obj is ColorTransform transform && Equals(transform);
    ...
    /// </returns>
    public override readonly int GetHashCode() => HashCode.Combine(AlphaMultiplier, RedMultiplier, GreenMultiplier, BlueMultiplier, AlphaOffset, RedOffset, GreenOffset, BlueOffset);
    #endregion Methods
}
