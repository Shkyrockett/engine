    ...
    : IColor, IEquatable<CIELAB>
{
    ...
    /// </returns>
    public override readonly bool Equals(object? obj) => obj is CIELAB color && Equals(color);
    ...
    /// </returns>
    public readonly bool Equals([AllowNull] CIELAB other) => Lightness == other.Lightness && ChannelA == other.ChannelA && ChannelB == other.ChannelB;
    ...
    /// </returns>
    public override readonly int GetHashCode() => HashCode.Combine(Lightness, ChannelA, ChannelB);
    ...
    public readonly string ToString(string? format, IFormatProvider? formatProvider) => $"{nameof(Lightness)}: {Lightness}, {nameof(ChannelA)}: {ChannelA}, {nameof(ChannelB)}: {ChannelB}";
}
