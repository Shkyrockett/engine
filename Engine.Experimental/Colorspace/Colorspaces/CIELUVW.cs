    ...
    : IColor, IEquatable<CIELUVW>
{
    ...
    /// </returns>
    public override readonly bool Equals(object? obj) => obj is CIELUVW cIELUVW && Equals(cIELUVW);
    ...
    /// </returns>
    public readonly bool Equals([AllowNull] CIELUVW other) => Luminance == other.Luminance && U == other.U && V == other.V;
