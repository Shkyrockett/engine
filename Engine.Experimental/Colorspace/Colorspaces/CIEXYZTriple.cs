    ...
    : IColor, IEquatable<CIEXYZTriple>
{
    ...
    /// </returns>
    public override readonly bool Equals(object? obj) => obj is CIEXYZTriple triple && Equals(triple);
    ...
    /// </returns>
    public readonly bool Equals([AllowNull] CIEXYZTriple other) => EqualityComparer<CIEXYZ>.Default.Equals(Red, other.Red) && EqualityComparer<CIEXYZ>.Default.Equals(Green, other.Green) && EqualityComparer<CIEXYZ>.Default.Equals(Blue, other.Blue);
