    ...
    : IColor, IEquatable<CIExyYTriple>
{
    ...
    /// </returns>
    public override readonly bool Equals(object? obj) => obj is CIExyYTriple triple && Equals(triple);
    ...
    /// </returns>
    public readonly bool Equals([AllowNull] CIExyYTriple other) => EqualityComparer<CIExyY>.Default.Equals(Red, other.Red) && EqualityComparer<CIExyY>.Default.Equals(Green, other.Green) && EqualityComparer<CIExyY>.Default.Equals(Blue, other.Blue);
    ...
    /// </returns>
    public override readonly int GetHashCode() => HashCode.Combine(Red, Green, Blue);
