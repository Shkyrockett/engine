...
namespace Engine.Colorspace
{
        ...
        : IColor, IEquatable<CIExyYTriple>
    {
        ...
        /// </returns>
        public bool Equals([AllowNull] CIExyYTriple other) => EqualityComparer<CIExyY>.Default.Equals(Red, other.Red) && EqualityComparer<CIExyY>.Default.Equals(Green, other.Green) && EqualityComparer<CIExyY>.Default.Equals(Blue, other.Blue);
