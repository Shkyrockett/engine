...
public class BooleanOpImp
{
    ...
    /// </summary>
    private readonly PriorityQueue<SweepEvent> eq = new();

    /// <summary>
    /// segments intersecting the sweep line
    /// </summary>
    private readonly SortedSet<SweepEvent> sl = [];

    /// <summary>
    /// It holds the events generated during the computation of the boolean operation
    /// </summary>
    private readonly LinkedList<SweepEvent> eventHolder = new();

    /// <summary>
    /// to compare events
    /// </summary>
    private readonly SweepEventComp sec = new();

    /// <summary>
    /// The sorted events (readonly). Value: new LinkedList&lt;SweepEvent&gt;().
    /// </summary>
    private readonly LinkedList<SweepEvent> sortedEvents = new();
