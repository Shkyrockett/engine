...
namespace Engine
{
    ...
    public static partial class IntersectionsBobLyon
    {
            ...
            double epsilon = Epsilon)
        {
            ...
            if (Intersections.EllipseContainsPoint(u0, v0, rx0, ry0, cosA0, sinA0, u1, v1) != Inclusion.Inside
             || Intersections.EllipseContainsPoint(u1, v1, rx1, ry1, cosA1, sinA1, u0, v0) != Inclusion.Inside)
            {
                return true;
            }
