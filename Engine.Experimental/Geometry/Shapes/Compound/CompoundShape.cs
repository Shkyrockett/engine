    ...
    : IEquatable<CompoundShape<T>> where T : IPrimitive
{
    ...
    /// </returns>
    public override readonly bool Equals(object obj) => obj is CompoundShape<T> shape && Equals(shape);
    ...
    /// </returns>
    public readonly bool Equals([AllowNull] CompoundShape<T> other) => EqualityComparer<T[]>.Default.Equals(Primitives, other.Primitives);
    ...
    /// </returns>
    public override readonly int GetHashCode() => HashCode.Combine(Primitives);
}
