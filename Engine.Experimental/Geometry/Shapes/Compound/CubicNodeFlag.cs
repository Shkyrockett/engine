    ...
    : INodeItem, IEquatable<CubicNodeFlag>
{
    ...
    /// </returns>
    public override readonly bool Equals(object obj) => obj is CubicNodeFlag flag && Equals(flag);
    ...
    /// </returns>
    public readonly bool Equals([AllowNull] CubicNodeFlag other) => Elements == other.Elements;
    ...
    /// The <see cref="string" />.
    /// </returns>
    public readonly string ToString(string format, IFormatProvider formatProvider) => $"{nameof(CubicNodeFlag)}";
}
