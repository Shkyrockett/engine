    ...
    : IPrimitive, IEquatable<NumericItem>
{
    ...
    /// </returns>
    public override readonly bool Equals(object obj) => obj is NumericItem item && Equals(item);
    ...
    /// </returns>
    public readonly bool Equals([AllowNull] NumericItem other) => Value == other.Value;
    ...
    /// The <see cref="string" />.
    /// </returns>
    public readonly string ToString(string format, IFormatProvider formatProvider) => $"{nameof(NumericItem)}{{{nameof(Value)}={Value}}}";
}
