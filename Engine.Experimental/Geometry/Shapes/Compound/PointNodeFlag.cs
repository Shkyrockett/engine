    ...
    : INodeItem, IEquatable<PointNodeFlag>
{
    ...
    /// </returns>
    public override readonly bool Equals(object obj) => obj is PointNodeFlag flag && Equals(flag);
    ...
    /// </returns>
    public readonly bool Equals([AllowNull] PointNodeFlag other) => Elements == other.Elements;
    ...
    /// The <see cref="string" />.
    /// </returns>
    public readonly string ToString(string format, IFormatProvider formatProvider) => $"{nameof(PointNodeFlag)}";
}
