    ...
    : INodeItem, IEquatable<QuadraticNodeFlag>
{
    ...
    /// </returns>
    public override readonly bool Equals(object obj) => obj is QuadraticNodeFlag flag && Equals(flag);
    ...
    /// </returns>
    public readonly bool Equals([AllowNull] QuadraticNodeFlag other) => Elements == other.Elements;
    ...
    /// The <see cref="string" />.
    /// </returns>
    public readonly string ToString(string format, IFormatProvider formatProvider) => $"{nameof(QuadraticNodeFlag)}";
}
