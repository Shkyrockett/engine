...
namespace Engine
{
    ...
    public class Bezier
    {
        ...
        /// The lut.
        /// </summary>
        public List<Point2D> lut = new List<Point2D>();
        ...
        public Bezier(double x1, double y1, double v1, double v2, double x2, double y2)
        {
            ...
            DerivativePoints = DerivativeCoordinates_Ported(Points);
        ...
        public Bezier(double x1, double y1, double z1, double v1, double v2, double v3, double v4, double v5, double v6, double x2, double y2, double z2)
        {
            Points = new List<Point2D>
            {
                new Point2D(x1,y1/*,z1*/),
                new Point2D(v1,v2/*,v3*/),
        ...
        public Bezier(Point2D p1, Point2D p2, Point2D p3)
            : this(new List<Point2D> { p1, p2, p3 })
        { }
        ...
        public Bezier(Point2D p1, Point2D p2, Point2D p3, Point2D p4)
            : this(new List<Point2D> { p1, p2, p3, p4 })
        { }
        ...
        public double Length
            => BezierUtil.Length(Derivativate_Ported);
        ...
        /// http://pomax.github.io/bezierinfo/
        /// </acknowledgment>
        public List<double> Inflections_Ported
        ...
        /// http://pomax.github.io/bezierinfo/
        /// </acknowledgment>
        public List<double> Extrema_Ported
        {
            get
            {
        ...
        //[DebuggerStepThrough]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static List<List<Point2D>> DerivativeCoordinates_Ported(List<Point2D> Points)
        {
        ...
        public List<Point2D> GetLookUpTable(int steps = 100)
        {
            ...
            lut = new List<Point2D>();

            for (var t = 0; t <= steps; t++)
            {
                lut.Add(Interpolate_Ported(t / (double)steps));
            }
        ...
        public AccumulatorPoint2D Project(Point2D point)
        {
            ...
            {
                var t0 = mpos / l;
                AccumulatorPoint2D pt = Interpolate_Ported(t0);
                pt.Theta = t0;
        ...
        public Point2D Interpolate_Ported(double t)
        {
            ...
            if (Order < 4)
            {
                ...
                if (Order == 2)
                {
                    p = new List<Point2D> { Points[0], Points[1], Points[2], Point2D.Empty };
                    a = mt2;
                    b = mt * t * 2;
                    c = t2;
                }
        ...
        //[DebuggerStepThrough]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Point2D Derivativate_Ported(double t)
        {
            var ti = 1 - t;
            double a = 0;
            double b = 0;
        ...
        //[DebuggerStepThrough]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public List<Point2D> Hull_Ported(double t)
        {
            var p = Points;
        ...
        {
            var c = Interpolate_Ported(t);
            var n = Normal_Ported(t);
            return (
                c,
                (Point2D)n,
                new Point2D(
        ...
        public List<Arc2D> Iterate(double errorThreshold, List<Arc2D> circles)
        {
            ...
            do
            {
                ...
                do
                {
                    ...
                    np2 = Interpolate_Ported(m);
                    np3 = Interpolate_Ported(e);
        ...
        public List<bool> LineIntersects(Line2D line)
        {
            ...
            return new List<bool>(
                ...
                let p = self.Interpolate_Ported(t)
