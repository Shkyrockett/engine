...
public class BezierFragment
{
    ...
    /// </summary>
    private static readonly double[] Bezier01 = [0, 1];
    ...
    /// </summary>
    private static readonly Polynomialx T = new(0, 1);
    ...
    public BezierFragment[] Split(double t)
    {
        ...
        return [new BezierFragment([.. r0]), new BezierFragment([.. r1])];
    }
    ...
    /// The <see cref="Array" />.
    /// </returns>
    public BezierFragment[] Split(params double[] ts) => Split((IEnumerable<double>)ts);
