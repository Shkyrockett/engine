...
public struct Line3D : IEquatable<Line3D>
{
    ...
    /// </returns>
    public override readonly bool Equals(object obj) => obj is Line3D d && Equals(d);
    ...
    /// </returns>
    public readonly bool Equals([AllowNull] Line3D other) => P1.Equals(other.P1) && P2.Equals(other.P2);
