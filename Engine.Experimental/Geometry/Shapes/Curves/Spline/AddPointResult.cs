    ...
    : IEquatable<AddPointResult>
{
    ...
    /// </value>
    public readonly int FirstChangedIndex => Math.Abs(data) - 1;
    ...
    /// </value>
    public readonly bool WasAdded => data < 0;
    ...
    /// </value>
    public readonly bool WasChanged => data != 0;
    ...
    /// </returns>
    public override readonly bool Equals(object obj) => obj is AddPointResult result && Equals(result);
    ...
    /// </returns>
    public readonly bool Equals([AllowNull] AddPointResult other) => data == other.data;
    ...
    /// </returns>
    public override readonly int GetHashCode() => HashCode.Combine(data);
}
