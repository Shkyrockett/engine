...
public struct SamplePosition : IEquatable<SamplePosition>
{
    ...
    /// </returns>
    public override readonly bool Equals(object obj) => obj is SamplePosition position && Equals(position);
    ...
    /// </returns>
    public readonly bool Equals([AllowNull] SamplePosition other) => Index == other.Index && Time == other.Time;
    ...
    /// </returns>
    public override readonly int GetHashCode() => HashCode.Combine(Index, Time);
