...
namespace Engine
{
        ...
        : IEnergy, IEquatable<ElectronVolt>
    {
        ...
        /// </returns>
        public static bool operator ==(ElectronVolt left, ElectronVolt right) => left.Equals(right);
        ...
        /// The result of the operator.
        /// </returns>
        public static bool operator !=(ElectronVolt left, ElectronVolt right) => !(left == right);
        ...
        /// </returns>
        public override bool Equals(object obj) => obj is ElectronVolt volt && Equals(volt);
        ...
        /// </returns>
        public bool Equals([AllowNull] ElectronVolt other) => Value == other.Value;
