...
namespace Engine
{
        ...
        : IEnergy, IEquatable<Hertz>
    {
        ...
        /// The result of the operator.
        /// </returns>
        public static bool operator !=(Hertz left, Hertz right) => !(left == right);
        ...
        /// </returns>
        public override bool Equals(object obj) => obj is Hertz hertz && Equals(hertz);
        ...
        /// </returns>
        public bool Equals([AllowNull] Hertz other) => Value == other.Value;
