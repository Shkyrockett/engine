...
public struct Mils<T>
    : ILength<T>, IFormattable, IEquatable<Mils<T>>
    where T : INumber<T>
{
    #region Constants
    /// <summary>
    /// The mil (static readonly). Value:T.One.
    /// </summary>
    public static readonly T Mil = T.One;

    /// <summary>
    /// The centimeter (static readonly). Value:T.One / MilsInCentimeter.
    /// </summary>
    public static readonly T Centimeter = T.One / LengthUnits<T>.MilsInCentimeter; //T.One / 393.700787d;

    /// <summary>
    /// The inch (static readonly). Value:T.One / 1000d.
    /// </summary>
    public static readonly T Inch = T.One / T.CreateSaturating(1000);

    /// <summary>
    /// The foot (static readonly). Value:T.One / 12000d.
    /// </summary>
    public static readonly T Foot = T.One / T.CreateSaturating(12000);

    /// <summary>
    /// The yard (static readonly). Value:T.One / 36000d.
    /// </summary>
    public static readonly T Yard = T.One / T.CreateSaturating(36000);

    /// <summary>
    /// The meter (static readonly). Value:T.One / 39370.0787d.
    /// </summary>
    public static readonly T Meter = T.One / T.CreateSaturating(39370.0787);
    ...
    /// <summary>
    /// The kilometer (static readonly). Value:T.One / 3.9370E+7d.
    /// </summary>
    public static readonly T Kilometer = T.One / T.CreateSaturating(3.9370E+7);

    /// <summary>
    /// The mile (static readonly). Value:T.One / 63360000d.
    /// </summary>
    public static readonly T Mile = T.One / T.CreateSaturating(63360000);

    /// <summary>
    /// The nautical mile (static readonly). Value:T.One / 7.2913E+7d.
    /// </summary>
    public static readonly T NauticalMile = T.One / T.CreateSaturating(7.2913E+7);
    #endregion Constants
    ...
    #region Operators
    /// <summary>
    /// Performs an implicit conversion from <see cref="T"/> to <see cref="Mils"/>.
    /// </summary>
    /// <param name="value">The value.</param>
    /// <returns>
    /// The result of the conversion.
    /// </returns>
    public static implicit operator Mils<T>(T value)
        => new(value);
    ...
    /// The result of the conversion.
    /// </returns>
    public static explicit operator Mils<T>(Centimeters<T> value)
        => value.Mils;
    ...
    /// The result of the conversion.
    /// </returns>
    public static explicit operator Mils<T>(Inches<T> value)
        => value.Mils;
    ...
    /// The result of the conversion.
    /// </returns>
    public static explicit operator Mils<T>(Meters<T> value)
        => value.Mils;
    ...
    /// The result of the conversion.
    /// </returns>
    public static explicit operator Mils<T>(Smoots<T> value)
        => value.Mils;
    ...
    /// The result of the conversion.
    /// </returns>
    public static explicit operator Mils<T>(Feet<T> value)
        => value.Mils;
    ...
    /// The result of the conversion.
    /// </returns>
    public static explicit operator Mils<T>(Yards<T> value)
        => value.Mils;
    ...
    /// The result of the conversion.
    /// </returns>
    public static explicit operator Mils<T>(Miles<T> value)
        => value.Mils;
    ...
    /// The result of the conversion.
    /// </returns>
    public static explicit operator Mils<T>(Kilometers<T> value)
        => value.Mils;
    ...
    /// The result of the conversion.
    /// </returns>
    public static explicit operator Mils<T>(NauticalMiles<T> value)
        => value.Mils;
    ...
    /// </returns>
    public static bool operator ==(Mils<T> left, Mils<T> right) => left.Equals(right);
    ...
    /// The result of the operator.
    /// </returns>
    public static bool operator !=(Mils<T> left, Mils<T> right) => !(left == right);
    #endregion Operators
    ...
    /// </returns>
    public override readonly bool Equals(object? obj) => obj is Mils<T> mils && Equals(mils);
    ...
    /// </returns>
    public readonly bool Equals([AllowNull] Mils<T> other) => Value == other.Value;
