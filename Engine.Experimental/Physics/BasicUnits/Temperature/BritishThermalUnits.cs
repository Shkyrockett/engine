...
namespace Engine
{
        ...
        : ITemperature, IEquatable<BritishThermalUnits>
    {
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="double"/> to <see cref="BritishThermalUnits"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>
        ...
        /// </returns>
        public bool Equals([AllowNull] BritishThermalUnits other) => Value == other.Value;
