...
namespace Engine
{
        ...
        : ISpeed, IEquatable<AverageSpeed>
    {
        ...
        /// </returns>
        public bool Equals([AllowNull] AverageSpeed other) => EqualityComparer<List<ISpeed>>.Default.Equals(Speed, other.Speed) && EqualityComparer<ITime>.Default.Equals(Time, other.Time);
        ...
        /// </returns>
        public override int GetHashCode() => HashCode.Combine(Speed, Time);
