...
namespace Engine
{
        ...
        : ILength, IEquatable<Distance>
    {
        ...
        /// </returns>
        public bool Equals([AllowNull] Distance other) => EqualityComparer<ISpeed>.Default.Equals(Speed, other.Speed) && EqualityComparer<ITime>.Default.Equals(Time, other.Time);
