...
namespace Engine
{
        ...
        : ILength, IEquatable<DistanceFreeFall>
    {
        ...
        /// </returns>
        public bool Equals([AllowNull] DistanceFreeFall other) => EqualityComparer<IAcceleration>.Default.Equals(Acceleration, other.Acceleration) && EqualityComparer<ITime>.Default.Equals(Time, other.Time);
