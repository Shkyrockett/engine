...
namespace Engine
{
        ...
        : IForce, IEquatable<Impulse>
    {
        ...
        /// </returns>
        public bool Equals([AllowNull] Impulse other) => EqualityComparer<IForce>.Default.Equals(Force, other.Force) && EqualityComparer<ITime>.Default.Equals(Time, other.Time);
        ...
        /// </returns>
        public override int GetHashCode() => HashCode.Combine(Force, Time);
