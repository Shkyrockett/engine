...
namespace Engine
{
        ...
        : IMomentum, IEquatable<Momentum>
    {
        ...
        /// </returns>
        public bool Equals(Momentum other) => EqualityComparer<IMass>.Default.Equals(Mass, other.Mass) && EqualityComparer<ISpeed>.Default.Equals(Velocity, other.Velocity);
