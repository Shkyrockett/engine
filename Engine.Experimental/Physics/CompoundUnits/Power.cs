...
namespace Engine
{
        ...
        : IPower, IEquatable<Power>
    {
        ...
        /// </returns>
        public bool Equals(Power other) => EqualityComparer<IEnergy>.Default.Equals(Work, other.Work) && EqualityComparer<ITime>.Default.Equals(Time, other.Time);
        ...
        {
            var hashCode = 639059588;
            hashCode = hashCode * -1521134295 + EqualityComparer<IEnergy>.Default.GetHashCode(Work);
