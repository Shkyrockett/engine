    ...
    : IEquatable<PackedNibble>
{
    ...
    {
        readonly get { return (byte)(packedValue >> 4); }
    ...
    {
        readonly get { return (byte)(packedValue & 0x0F); }
    ...
    /// The <see cref="bool" />.
    /// </returns>
    public readonly bool Equals(PackedNibble other) => packedValue == other.packedValue;
    ...
    /// The <see cref="int" />.
    /// </returns>
    public override readonly int GetHashCode() => packedValue;
}
