...
public static partial class GeometryOperations
{
    ...
    public static bool EqualsOrClose(Point2D p0, Point2D p1) => p0.SquareDistance(p1) < double.Epsilon;
    ...
    /// <returns>True if the vectors are almost equal.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static bool EqualsOrClose(Vector2D v0, Vector2D v1) => v0.SquareDistance(v1) < double.Epsilon;
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Point2D Center(this Rectangle2D rectangle) => new((0.5d * rectangle.Width) + rectangle.X, (0.5d * rectangle.Height) + rectangle.Y);
    #endregion Center
    ...
    public static Point2D Inflate(this Point2D point, Vector2D factors)
        => new(point.X * factors.I, point.Y * factors.J);
    ...
    public static Size2D Inflate(this Size2D size, Size2D factor)
        => new(size.Width * factor.Width, size.Height * factor.Height);
    ...
    public static Size2D Inflate(this Size2D size, Vector2D factor)
        => new(size.Width * factor.I, size.Height * factor.J);
    ...
    public static Vector2D Inflate(this Vector2D point, int factor)
        => new(point.I * factor, point.J * factor);
    ...
    public static Vector2D Inflate(this Vector2D point, Vector2D factors)
        => new(point.I * factors.I, point.J * factors.J);
    #endregion Inflate
    ...
    public static Vector2D Lerp(this Vector2D point1, Vector2D point2, double t)
        => new(point1.I + ((point2.I - point1.I) * t), point1.J + ((point2.J - point1.J) * t));
    ...
    public static Size2D Lerp(this Size2D point1, Size2D point2, double t)
        => new(point1.Width + ((point2.Width - point1.Width) * t), point1.Height + ((point2.Height - point1.Height) * t));
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Point2D Max(this Point2D point1, Point2D point2) => new(Math.Max(point1.X, point2.X), Math.Max(point1.Y, point2.Y));
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Vector2D Max(this Vector2D point1, Vector2D point2) => new(Math.Max(point1.I, point2.I), Math.Max(point1.J, point2.J));
    #endregion Max
    ...
    public static Vector2D Min(this Vector2D point1, Vector2D point2)
        => new(Math.Min(point1.I, point2.I), Math.Min(point1.J, point2.J));
    #endregion Min
