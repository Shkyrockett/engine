...
public static partial class Interpolators
{
    ...
    public static List<Point2D> Interpolate0to1(int count, Func<double, Point2D> func) => new(from i in Enumerable.Range(0, count) select func(1d / count * i));
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Point2D Linear(double t, Point2D a, Point2D b) => new(Linear(t, a.X, a.Y, b.X, b.Y));
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Point3D Linear(double t, Point3D a, Point3D b) => new(Linear(t, a.X, a.Y, a.Z, b.X, b.Y, b.Z));
    ...
    /// </acknowledgment>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Point2D Nlerp(double t, Point2D a, Point2D b) => Normalize(((double i, double j))Linear(t, a, b));
    ...
    /// </acknowledgment>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Point3D Nlerp(double t, Point3D a, Point3D b) => Normalize(((double i, double j, double k))Linear(t, a, b));
    ...
    public static Point2D Slerp(double percent, Point2D a, Point2D b)
    {
        ...
        // Orthonormal basis
        Normalize(((double i, double j))RelativeVec);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static double Curve(double t, Polynomial<double> vCurve)
    {
        var v = 0d;
    ...
    /// <returns>The <see cref="ValueTuple{T1, T2}"/>.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static (double x, double y) Curve(double t, Polynomial<double> xCurve, Polynomial<double> yCurve)
    {
        var (x, y) = (0d, 0d);
    ...
    /// <returns>The <see cref="ValueTuple{T1, T2, T3}"/>.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static (double x, double y, double z) Curve(double t, Polynomial<double> xCurve, Polynomial<double> yCurve, Polynomial<double> zCurve)
    {
        var (x, y, z) = (0d, 0d, 0d);
        for (int s = xCurve.Count - 1, d = 0; s >= 0; s--, d++)
        {
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static (double X, double Y) QuinticBezier(double t, double p0X, double p0Y, double p1X, double p1Y, double p2X, double p2Y, double p3X, double p3Y, double p4X, double p4Y) => CubicBezierSpline(t, [(p0X, p0Y), (p1X, p1Y), (p2X, p2Y), (p3X, p3Y), (p4X, p4Y)]);
    #endregion
    ...
    /// <returns>Interpolated point at theta.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static (R X, R Y) Ellipse<T, R>(R t, T cX, T cY, T r1, T r2, R angle)
        where T : INumber<T> where R : IFloatingPointIeee754<R> => Ellipse(R.Cos(t), R.Sin(t), cX, cY, r1, r2, R.Cos(angle), R.Sin(angle));
    ...
    /// <returns>Interpolated point at theta.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static (R X, R Y) Ellipse<T, R>(R t, T cX, T cY, T r1, T r2, R cosAngle, R sinAngle)
        where T : INumber<T> where R : IFloatingPointIeee754<R> => Ellipse(R.Cos(t), R.Sin(t), cX, cY, r1, r2, cosAngle, sinAngle);
    ...
    /// </acknowledgment>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static (R X, R Y) Ellipse<T, R>(R cosTheta, R sinTheta, T cX, T cY, T r1, T r2, R cosAngle, R sinAngle)
        where T : INumber<T>
        where R : IFloatingPointIeee754<R>
    {
        // Ellipse equation for an ellipse at origin.
        var u = R.CreateSaturating(r1) * cosTheta;
        var v = -(R.CreateSaturating(r2) * sinTheta);

        // Apply the rotation transformation and translate to new center.
        return (
            R.CreateSaturating(cX) + ((u * cosAngle) + (v * sinAngle)),
            R.CreateSaturating(cY) + ((u * sinAngle) - (v * cosAngle)));
    }
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static (R X, R Y) ParametricEllipseEquation<T, R>(R t, T a, T b, T h, T k, R theta)
        where T : INumber<T>
        where R : IFloatingPointIeee754<R>
    {
        R cosTheta = R.Cos(theta);
        R sinTheta = R.Sin(theta);

        R x = R.CreateSaturating(h) + R.CreateSaturating(a) * R.Cos(t) * cosTheta - R.CreateSaturating(b) * R.Sin(t) * sinTheta;
        R y = R.CreateSaturating(k) + R.CreateSaturating(a) * R.Cos(t) * sinTheta + R.CreateSaturating(b) * R.Sin(t) * cosTheta;
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static R ImplicitEllipseEquation<T, P, R>(P x, P y, T a, T b, T h, T k, R theta)
        where T : INumber<T>
        where P : INumber<P>
        where R : IFloatingPointIeee754<R>
    {
        ...
        var xPrime = cosTheta * (R.CreateSaturating(x) - R.CreateSaturating(h)) + sinTheta * R.CreateSaturating(R.CreateSaturating(y) - R.CreateSaturating(k));
        var yPrime = -sinTheta * (R.CreateSaturating(x) - R.CreateSaturating(h)) + cosTheta * R.CreateSaturating(R.CreateSaturating(y) - R.CreateSaturating(k));

        return (xPrime * xPrime) / R.CreateSaturating(a * a) + (yPrime * yPrime) / R.CreateSaturating(b * b) - R.One;
    }

    /// <summary>
    /// Implicits the equation gradient.
    /// </summary>
    /// <typeparam name="T"></typeparam>
    /// <typeparam name="P"></typeparam>
    /// <typeparam name="R"></typeparam>
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static (R X, R Y) ImplicitEllipseEquationGradient<T, P, R>(P x, P y, T a, T b, T h, T k, R theta)
        where T : INumber<T>
        where P : INumber<P>
        where R : IFloatingPointIeee754<R>
    {
        ...
        var xPrime = cosTheta * (R.CreateSaturating(x) - R.CreateSaturating(h)) + sinTheta * (R.CreateSaturating(y) - R.CreateSaturating(k));
        var yPrime = -sinTheta * (R.CreateSaturating(x) - R.CreateSaturating(h)) + cosTheta * (R.CreateSaturating(y) - R.CreateSaturating(k));

        var fx = Integers<R>.Two * xPrime / R.CreateSaturating(a * a) * cosTheta + Integers<R>.Two * yPrime / R.CreateSaturating(b * b) * sinTheta;
        var fy = Integers<R>.Two * xPrime / R.CreateSaturating(a * a) * sinTheta - Integers<R>.Two * yPrime / R.CreateSaturating(b * b) * cosTheta;
