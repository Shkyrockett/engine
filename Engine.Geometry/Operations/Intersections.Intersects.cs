...
namespace Engine
{
    ...
    public static partial class Intersections
    {
        ...
        public static bool Intersects(Rectangle2D rect, Shape2D shape, double epsilon = Epsilon)
        {
            ...
            return shape switch
            {
                ScreenPoint2D p => PointRectangleIntersects(p.X, p.Y, rect.X, rect.Y, rect.Right, rect.Bottom, epsilon),//return RectangleContainsPoint(rect.X, rect.Y, rect.Right, rect.Bottom, p.X, p.Y, epsilon)!= Inclusion.Outside ;
                ...
                Polyline2D _ => throw new NotImplementedException(),//return RectanglePolylineIntersects();
        ...
        public static bool LineRayIntersects(
            ...
            double epsilon = Epsilon)
        {
            // ToDo: Figure out Line Ray2D intersection.
