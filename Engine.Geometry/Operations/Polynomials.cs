// <copyright file="Polynomials.cs" company="Shkyrockett" >
...
public static class Polynomials
{
    ...
    public static Polynomial<double> Bezier(params double[] values)
    {
        Contract.Ensures(Contract.Result<Polynomial<double>>() != null);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    private static Polynomial<double> Bezier(int from, int to, params double[] values)
        => (from == to)
        ? new Polynomial<double>(values[from])
        : (Polynomial<double>.OneMinusT * Bezier(from, to - 1, values)) + (Polynomial<double>.T * Bezier(from + 1, to, values));
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Polynomial<double> LinearBezierBernsteinBasisRecursive(double a, double b) => (Polynomial<double>.OneMinusT * a) + (Polynomial<double>.T * b);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Polynomial<double> QuadraticBezierBernsteinBasisRecursive(double a, double b, double c) => (Polynomial<double>.OneMinusT * LinearBezierBernsteinBasisRecursive(a, b)) + (Polynomial<double>.T * LinearBezierBernsteinBasisRecursive(b, c));
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Polynomial<double> CubicBezierBernsteinBasisRecursive(double a, double b, double c, double d) => (Polynomial<double>.OneMinusT * QuadraticBezierBernsteinBasisRecursive(a, b, c)) + (Polynomial<double>.T * QuadraticBezierBernsteinBasisRecursive(b, c, d));
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Polynomial<double> QuarticBezierBernsteinBasisRecursive(double a, double b, double c, double d, double e) => (Polynomial<double>.OneMinusT * CubicBezierBernsteinBasisRecursive(a, b, c, d)) + (Polynomial<double>.T * CubicBezierBernsteinBasisRecursive(b, c, d, e));
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Polynomial<double> QuinticBezierBernsteinBasisRecursive(double a, double b, double c, double d, double e, double f) => (Polynomial<double>.OneMinusT * QuarticBezierBernsteinBasisRecursive(a, b, c, d, e)) + (Polynomial<double>.T * QuarticBezierBernsteinBasisRecursive(b, c, d, e, f));
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Polynomial<double> SexticBezierBernsteinBasisRecursive(double a, double b, double c, double d, double e, double f, double g) => (Polynomial<double>.OneMinusT * QuinticBezierBernsteinBasisRecursive(a, b, c, d, e, f)) + (Polynomial<double>.T * QuinticBezierBernsteinBasisRecursive(b, c, d, e, f, g));
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Polynomial<double> SepticBezierBernsteinBasisRecursive(double a, double b, double c, double d, double e, double f, double g, double h) => (Polynomial<double>.OneMinusT * SexticBezierBernsteinBasisRecursive(a, b, c, d, e, f, g)) + (Polynomial<double>.T * SexticBezierBernsteinBasisRecursive(b, c, d, e, f, g, h));
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Polynomial<double> OcticBezierBernsteinBasisRecursive(double a, double b, double c, double d, double e, double f, double g, double h, double i) => (Polynomial<double>.OneMinusT * SepticBezierBernsteinBasisRecursive(a, b, c, d, e, f, g, h)) + (Polynomial<double>.T * SepticBezierBernsteinBasisRecursive(b, c, d, e, f, g, h, i));
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Polynomial<double> NonicBezierBernsteinBasisRecursive(double a, double b, double c, double d, double e, double f, double g, double h, double i, double j) => (Polynomial<double>.OneMinusT * OcticBezierBernsteinBasisRecursive(a, b, c, d, e, f, g, h, i)) + (Polynomial<double>.T * OcticBezierBernsteinBasisRecursive(b, c, d, e, f, g, h, i, j));
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Polynomial<double> DecicBezierBernsteinBasisRecursive(double a, double b, double c, double d, double e, double f, double g, double h, double i, double j, double k) => (Polynomial<double>.OneMinusT * NonicBezierBernsteinBasisRecursive(a, b, c, d, e, f, g, h, i, j)) + (Polynomial<double>.T * NonicBezierBernsteinBasisRecursive(b, c, d, e, f, g, h, i, j, k));
    #endregion Bézier Bernstein Polynomial Recursive

    #region Curve Bernstein Basis
    /// <summary>
    ...
    /// </acknowledgment>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static (T a, T b, T c, T d, T e, T f) OrthogonalEllipseConicSectionPolynomial<T>(T h, T k, T a, T b)
        where T : IFloatingPointIeee754<T>
    {
        ...
        return (
            ...
            b: T.Zero,
            c: coefC,
            d: Integers<T>.NegativeTwo * coefA * h,
            e: Integers<T>.NegativeTwo * coefC * k,
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static (T a, T b, T c, T d, T e, T f) EllipseConicSectionPolynomial<T>(T h, T k, T a, T b, T angle) where T : IFloatingPointIeee754<T> => EllipseConicSectionPolynomial(h, k, a, b, T.Cos(angle), T.Sin(angle));
    ...
    /// </acknowledgment>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static (T a, T b, T c, T d, T e, T f) EllipseConicSectionPolynomial<T>(T h, T k, T a, T b, T cos, T sin)
        where T : IFloatingPointIeee754<T>
    {
        ...
        if (sin == T.One || sin == T.NegativeOne) cos = T.Zero;

        var coefA = (a * a * sin * sin) + (b * b * cos * cos);
        var coefB = Integers<T>.Two * ((b * b) - (a * a)) * sin * cos;
        var coefC = (a * a * cos * cos) + (b * b * sin * sin);
        return (
            a: coefA,
            b: coefB,
            c: coefC,
            d: (Integers<T>.NegativeTwo * coefA * h) - (coefB * k),
            e: (Integers<T>.NegativeTwo * coefC * k) - (coefB * h),
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static (double a, double b, double c, double d, double e) ConicSectionBezout(Polynomial<double> a, Polynomial<double> b) => ConicSectionBezout(a[0], a[1], a[2], a[3], a[4], a[5], b[0], b[1], b[2], b[3], b[4], b[5]);
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static (T a, T b, T c, T d, T e) ConicSectionBezout<T>(
        (T a, T b, T c, T d, T e, T f) a,
        (T a, T b, T c, T d, T e, T f) b) where T : IFloatingPointIeee754<T> => ConicSectionBezout(a.a, a.b, a.c, a.d, a.e, a.f, b.a, b.b, b.c, b.d, b.e, b.f);
    ...
    /// </acknowledgment>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static (T a, T b, T c, T d, T e) ConicSectionBezout<T>(Span<T> e1, Span<T> e2) where T : IFloatingPointIeee754<T>
    {
    ...
    /// </acknowledgment>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static (T a, T b, T c, T d, T e) GetConicSectionQuartic<T>(
        (T a, T b, T c, T d, T e, T f) a,
        (T a, T b, T c, T d, T e, T f) b)
        where T : IFloatingPointIeee754<T> =>
        // ToDo: This seems to be reversed from Bezout. IT seems like this might work with everything else if reversed. Needs testing.
        (
            a: (a.f * a.a * b.d * b.d) + (a.a * a.a * b.f * b.f) - (a.d * a.a * b.d * b.f) + (b.a * b.a * a.f * a.f) - (Integers<T>.Two * a.a * b.f * b.a * a.f) - (a.d * b.d * b.a * a.f) + (b.a * a.d * a.d * b.f),
            b: (b.e * a.d * a.d * b.a) - (b.f * b.d * a.a * a.b) - (Integers<T>.Two * a.a * b.f * b.a * a.e) - (a.f * b.a * b.b * a.d) + (Integers<T>.Two * b.d * b.b * a.a * a.f) + (Integers<T>.Two * b.e * b.f * a.a * a.a) + (b.d * b.d * a.a * a.e) - (b.e * b.d * a.a * a.d) - (Integers<T>.Two * a.a * b.e * b.a * a.f) - (a.f * b.a * b.d * a.b) + (Integers<T>.Two * a.f * a.e * b.a * b.a) - (b.f * b.b * a.a * a.d) - (a.e * b.a * b.d * a.d) + (Integers<T>.Two * b.f * a.b * b.a * a.d),
            c: (b.e * b.e * a.a * a.a) + (Integers<T>.Two * b.c * b.f * a.a * a.a) - (a.e * b.a * b.d * a.b) + (b.f * b.a * a.b * a.b) - (a.e * b.a * b.b * a.d) - (b.f * b.b * a.a * a.b) - (Integers<T>.Two * a.a * b.e * b.a * a.e) + (Integers<T>.Two * b.d * b.b * a.a * a.e) - (b.c * b.d * a.a * a.d) - (Integers<T>.Two * a.a * b.c * b.a * a.f) + (b.b * b.b * a.a * a.f) + (Integers<T>.Two * b.e * a.b * b.a * a.d) + (a.e * a.e * b.a * b.a) - (a.c * b.a * b.d * a.d) - (b.e * b.b * a.a * a.d) + (Integers<T>.Two * a.f * a.c * b.a * b.a) - (a.f * b.a * b.b * a.b) + (b.c * a.d * a.d * b.a) + (b.d * b.d * a.a * a.c) - (b.e * b.d * a.a * a.b) - (Integers<T>.Two * a.a * b.f * b.a * a.c),
            d: (Integers<T>.NegativeTwo * a.a * b.a * a.c * b.e) + (b.e * b.a * a.b * a.b) + (Integers<T>.Two * b.c * a.b * b.a * a.d) - (a.c * b.a * b.b * a.d) + (b.b * b.b * a.a * a.e) - (b.e * b.b * a.a * a.b) - (Integers<T>.Two * a.a * b.c * b.a * a.e) - (a.e * b.a * b.b * a.b) - (b.c * b.b * a.a * a.d) + (Integers<T>.Two * b.e * b.c * a.a * a.a) + (Integers<T>.Two * a.e * a.c * b.a * b.a) - (a.c * b.a * b.d * a.b) + (Integers<T>.Two * b.d * b.b * a.a * a.c) - (b.c * b.d * a.a * a.b),
            e: (a.a * a.a * b.c * b.c) - (Integers<T>.Two * a.a * b.c * b.a * a.c) + (b.a * b.a * a.c * a.c) - (a.b * a.a * b.b * b.c) - (a.b * b.b * b.a * a.c) + (a.b * a.b * b.a * b.c) + (a.c * a.a * b.b * b.b)
        );
    #endregion Helpers
}
