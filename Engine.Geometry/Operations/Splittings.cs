...
public static class Splittings
{
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static unsafe Span<Ray2D> Split(this Line2D line, double t) => new Ray2D[] { new(line.Interpolate(t), -line.Direction), new(line.Interpolate(t), line.Direction) };
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static unsafe Span<IShapeSegment> Split(this Ray2D ray, double t) => Split(ray, [t]);
    ...
    public static unsafe Span<BezierSegment2D> SplitBezier(IEnumerable<Point2D> points, double t)
    {
        ...
        return new[] {
            new BezierSegment2D([.. bezier1]),
            new BezierSegment2D([.. bezier2])
        };
    }
    #endregion
}
