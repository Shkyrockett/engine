    ...
    : IVector<AccumulatorPoint2D>
{
    ...
    /// </summary>
    public static readonly AccumulatorPoint2D Empty = new(0d, 0d);

    /// <summary>
    /// A Unit <see cref="AccumulatorPoint2D"/>.
    /// </summary>
    public static readonly AccumulatorPoint2D Unit = new(1d, 1d);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    [EditorBrowsable(EditorBrowsableState.Never)]
    public readonly void Deconstruct(out double x, out double y, out double theta, out double totalDistance, out int previousIndex)
    {
        x = X;
        y = Y;
        theta = Theta;
    ...
    [IgnoreDataMember, XmlIgnore, SoapIgnore]
    [Browsable(false)]
    public readonly bool IsEmpty => Operations.IsEmptyVector(X, Y);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static implicit operator AccumulatorPoint2D(Point2D point) => new(point.X, point.Y);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static implicit operator Point2D(AccumulatorPoint2D point) => new(point.X, point.Y);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public override readonly bool Equals(object obj) => obj is AccumulatorPoint2D d && Equals(this, d);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly bool Equals(AccumulatorPoint2D value) => Equals(this, value);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly Point2D ToPoint() => new(X, Y);
