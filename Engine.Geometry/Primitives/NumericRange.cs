    ...
    : IEnumerable<double>, IEquatable<NumericRange>
{
    ...
    /// </returns>
    public static NumericRange IteratorRange(double count) => new(0d, 1d, 0d, 1d, 1d / count, Overflow.Clamp);
    ...
    /// </returns>
    public static NumericRange StartLengthCountRange(double start, double length, int count) => new(start, start + length, start, start + length, length / count, Overflow.Clamp);
    ...
    /// </returns>
    public static NumericRange RadiansRange(double start, double end, int count) => new(start, end, -PI, PI, (end - start) / count, Overflow.Wrap);
    ...
    /// </returns>
    public static NumericRange DegreesRange(double start, double end) => new(start, end, 0d, 360d, 1d, Overflow.Wrap);
    #endregion Factories
    ...
    /// </returns>
    public readonly double this[double index] => Overflow switch
    {
    ...
    /// </returns>
    public override bool Equals(object obj) => obj is NumericRange d && Equals(d);
    ...
    /// </returns>
    public readonly bool Equals([AllowNull] NumericRange other) => Min == other.Min && Max == other.Max && UnitMin == other.UnitMin && UnitMax == other.UnitMax && Step == other.Step && Overflow == other.Overflow;
    ...
    /// </returns>
    public override readonly int GetHashCode() => HashCode.Combine(Min, Max, UnitMin, UnitMax, Step, Overflow);
    #endregion Methods
}
