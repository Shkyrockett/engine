    ...
    : IVector<Point5D>
{
    ...
    public readonly void Deconstruct(out double x, out double y, out double z, out double w, out double v) => (x, y, z, w, v) = (X, Y, Z, W, V);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static explicit operator Point5D(Vector5D vector) => new(vector.I, vector.J, vector.K, vector.L, vector.M);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static explicit operator Vector5D(Point5D point) => new(point.X, point.Y, point.Z, point.W, point.V);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static implicit operator Point5D((double X, double Y, double Z, double W, double V) tuple) => new(tuple);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly bool Equals([AllowNull] Point5D other) => X == other.X && Y == other.Y && Z == other.Z && W == other.W && W == other.V;
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Point5D FromVector5D(Vector5D vector) => new(vector.I, vector.J, vector.K, vector.L, vector.M);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly Vector5D ToVector5D() => new(X, Y, Z, W, V);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Point5D FromValueTuple((double X, double Y, double Z, double W, double V) tuple) => new(tuple);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly (double X, double Y, double Z, double W, double V) ToValueTuple() => (X, Y, Z, W, V);
    #endregion
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public override readonly int GetHashCode() => HashCode.Combine(X, Y, Z, W, V);
