    ...
    : IVector<Size3D>
{
    ...
    public readonly void Deconstruct(out double width, out double height, out double depth) => (width, height, depth) = (Width, Height, Depth);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static explicit operator Size3D(Vector3D vector) => new(vector.I, vector.J, vector.K);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static explicit operator Vector3D(Size3D size) => new(size.Width, size.Height, size.Depth);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static implicit operator Size3D((double Width, double Height, double Depth) tuple) => new(tuple);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly bool Equals(Size3D other) => (Width == other.Width) && (Height == other.Height) && (Depth == other.Depth);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly (double Width, double Height, double Depth) ToValueTuple() => (Width, Height, Depth);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Size3D FromValueTuple((double Width, double Height, double Depth) tuple) => new(tuple.Width, tuple.Height, tuple.Depth);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly Size3D ToSize3D() => new(Width, Height, Depth);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Size3D FromSize3D(Size3D size) => new(size.Width, size.Height, size.Depth);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly Vector3D ToVector3D() => new(Width, Height, Depth);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Vector3D FromVector3D(Vector3D vector) => new(vector.I, vector.J, vector.K);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly Point3D ToPoint3D() => new(Width, Height, Depth);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Point3D FromPoint3D(Point3D point) => new(point.X, point.Y, point.Z);
    #endregion
