    ...
    : IVector<Size4D>
{
    ...
    /// </summary>
    public static readonly Size4D NaN = new(double.NaN, double.NaN, double.NaN, double.NaN);
    ...
    public readonly void Deconstruct(out double width, out double height, out double depth, out double breadth) => (width, height, depth, breadth) = (Width, Height, Depth, Breadth);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static explicit operator Size4D(Vector4D vector) => new(vector.I, vector.J, vector.K, vector.L);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static explicit operator Vector4D(Size4D size) => new(size.Width, size.Height, size.Depth, size.Breadth);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static explicit operator Size4D(Point4D point) => new(point.X, point.Y, point.Z, point.W);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static explicit operator Point4D(Size4D size) => new(size.Width, size.Height, size.Depth, size.Breadth);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static implicit operator Size4D((double Width, double Height, double Depth, double Breadth) tuple) => new(tuple);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly bool Equals(Size4D other) => (Width == other.Width) & (Height == other.Height) & (Depth == other.Depth) & (Breadth == other.Breadth);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly (double Width, double Height, double Depth, double Breadth) ToValueTuple() => (Width, Height, Depth, Breadth);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Size4D FromValueTuple((double Width, double Height, double Depth, double Breadth) tuple) => new(tuple.Width, tuple.Height, tuple.Depth, tuple.Breadth);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly Size4D ToSize4D() => new(Width, Height, Depth, Breadth);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Size4D FromSize4D(Size4D size) => new(size.Width, size.Height, size.Depth, size.Breadth);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly Vector4D ToVector4D() => new(Width, Height, Depth, Breadth);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Vector4D FromVector4D(Vector4D vector) => new(vector.I, vector.J, vector.K, vector.L);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly Point4D ToPoint4D() => new(Width, Height, Depth, Breadth);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Point4D FromPoint4D(Point4D point) => new(point.X, point.Y, point.Z, point.W);
    #endregion
    ...
    /// from the provided string using the <see cref="CultureInfo.InvariantCulture" />.
    /// </returns>
    public static Size4D Parse(string source, IFormatProvider formatProvider)
    {
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public override readonly int GetHashCode() => HashCode.Combine(Width, Height, Depth, Breadth);
