    ...
    : IVector<Size5D>
{
    ...
    /// </summary>
    public static readonly Size5D Empty = new(0d, 0d, 0d, 0d, 0d);
    ...
    /// </summary>
    public static readonly Size5D Unit = new(1d, 1d, 1d, 1d, 1d);
    ...
    /// </summary>
    public static readonly Size5D NaN = new(double.NaN, double.NaN, double.NaN, double.NaN, double.NaN);
    ...
    public readonly void Deconstruct(out double width, out double height, out double depth, out double breadth, out double length) => (width, height, depth, breadth, length) = (Width, Height, Depth, Breadth, Length);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static explicit operator Size5D(Vector5D vector) => new(vector.I, vector.J, vector.K, vector.L, vector.M);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static explicit operator Vector5D(Size5D size) => new(size.Width, size.Height, size.Depth, size.Breadth, size.Length);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static explicit operator Size5D(Point5D point) => new(point.X, point.Y, point.Z, point.W, point.V);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static explicit operator Point5D(Size5D size) => new(size.Width, size.Height, size.Depth, size.Breadth, size.Length);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static implicit operator Size5D((double Width, double Height, double Depth, double Breadth, double Length) tuple) => new(tuple);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public override readonly bool Equals([AllowNull] object obj) => obj is Point2D d && Equals(d);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly bool Equals(Size5D other) => (Width == other.Width) && (Height == other.Height) && (Depth == other.Depth) && (Breadth == other.Breadth) && (Length == other.Length);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly (double Width, double Height, double Depth, double Breadth, double Length) ToValueTuple() => (Width, Height, Depth, Breadth, Length);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Size5D FromValueTuple((double Width, double Height, double Depth, double Breadth, double Length) tuple) => new(tuple.Width, tuple.Height, tuple.Depth, tuple.Breadth, tuple.Length);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly Size5D ToSize5D() => new(Width, Height, Depth, Breadth, Length);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Size5D FromSize5D(Size5D size) => new(size.Width, size.Height, size.Depth, size.Breadth, size.Length);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly Vector5D ToVector5D() => new(Width, Height, Depth, Breadth, Length);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Vector5D FromVector5D(Vector5D vector) => new(vector.I, vector.J, vector.K, vector.L, vector.M);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly Point5D ToPoint5D() => new(Width, Height, Depth, Breadth, Length);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Point5D FromPoint5D(Point5D point) => new(point.X, point.Y, point.Z, point.W, point.V);
    #endregion
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public override readonly int GetHashCode() => HashCode.Combine(Width, Height, Depth, Breadth, Length);
