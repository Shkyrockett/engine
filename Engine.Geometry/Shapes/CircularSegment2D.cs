// <copyright file="CircularSegment2D.cs" company="Shkyrockett" >
...
[GraphicsObject]
[DisplayName(nameof(CircularSegment2D))]
[DebuggerDisplay("{ToString()}")]
public class CircularSegment2D
    : Shape2D
{
    #region Fields
    /// <summary>
    ...
    #region Constructors
    /// <summary>
    /// Initializes a new default instance of the <see cref="CircularSegment2D"/> class.
    /// </summary>
    public CircularSegment2D()
    ...
    public CircularSegment2D(double x, double y, double radius, double startAngle, double endAngle)
    {
        this.x = x;
        this.y = y;
        this.radius = radius;
    ...
    /// <param name="startAngle"></param>
    /// <param name="endAngle"></param>
    public CircularSegment2D(Point2D center, double radius, double startAngle, double endAngle)
    {
        x = center.X;
        y = center.Y;
        this.radius = radius;
    ...
    public CircularSegment2D(Point2D PointA, Point2D PointB, Point2D PointC)
    {
    ...
    /// <summary>
    /// Deconstruct this <see cref="CircularSegment2D"/> to a Tuple.
    /// </summary>
    /// <param name="x"></param>
    /// <param name="y"></param>
    ...
    public override Rectangle2D Bounds
    {
        get
        {
            ...
            Rectangle2D boundings()
            {
                ...
                if ((angleEnd >= Floats<double>.Hau) && (startAngle <= Floats<double>.Hau))
                {
                    bounds.Top = y - radius;
                }
                ...
                if ((angleEnd >= Floats<double>.Pau) && (startAngle <= Floats<double>.Pau))
                {
    ...
    #region Methods
    /// <summary>
    /// Creates a string representation of this <see cref="CircularSegment2D"/> struct based on the format string
    ...
    public override string ConvertToString(string format, IFormatProvider provider)
    {
        if (this is null)
        {
            return nameof(CircularSegment2D);
        }

        var sep = Tokenizer.GetNumericListSeparator(provider);
        IFormattable formatable = $"{nameof(CircularSegment2D)}{{{nameof(Center)}={Center}{sep}{nameof(Radius)}={radius}{sep}{nameof(StartAngle)}={startAngle}{sep}{nameof(EndAngle)}={endAngle}}}";
