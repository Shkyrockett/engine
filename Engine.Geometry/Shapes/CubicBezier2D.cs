...
namespace Engine
{
        ...
        : Shape2D, IEquatable<CubicBezier2D>
    {
        ...
        public Polynomial CurveX
        {
            get
            {
                var curveX = (Polynomial)CachingProperty(() => (Polynomial)CubicBezierBernsteinBasis(dx, cx, bx, ax));
        ...
        public Polynomial CurveY
        {
            get
            {
                var curveY = (Polynomial)CachingProperty(() => (Polynomial)CubicBezierBernsteinBasis(dy, cy, by, ay));
        ...
        public override string ConvertToString(string format, IFormatProvider provider)
        {
            ...
            IFormattable formatable = $"{nameof(CubicBezier2D)}={{{nameof(A)}={A}{sep}{nameof(B)}={B}{sep}{nameof(C)}={C}{sep}{nameof(D)}={D}}}";
