    ...
    : IEquatable<Envelope2D>
{
    ...
    {
        var w3 = width * Floats<double>.OneThird;
        var h3 = height * Floats<double>.OneThird;
    ...
    public readonly PolycurveContour2D ToPolycurve()
    {
    ...
    public override readonly int GetHashCode() => HashCode.Combine(ControlPointTopLeft, ControlPointTopRight, ControlPointBottomLeft, ControlPointBottomRight);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly bool Equals(Envelope2D envelope) => ControlPointTopLeft == envelope.ControlPointTopLeft
