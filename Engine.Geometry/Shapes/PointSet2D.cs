...
namespace Engine
{
        ...
        : Shape2D, IEnumerable<Point2D>
    {
        ...
        /// </summary>
        /// <param name="points">The points.</param>
        public PointSet2D(IEnumerable<Point2D> points)
        {
        ...
        public PointSet2D(IEnumerable<Polyline2D> polylines)
        {
        ...
        /// </summary>
        /// <param name="polygons">The polygons.</param>
        public PointSet2D(IEnumerable<PolygonContour2D> polygons)
        {
            if (polygons is null)
            {
