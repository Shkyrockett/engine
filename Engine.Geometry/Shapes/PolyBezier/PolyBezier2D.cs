    ...
    : Shape2D, IEnumerable<PolyBezierContour2D>
{
    ...
    /// </summary>
    /// <param name="points"></param>
    public PolyBezier2D(params IEnumerable<Point2D> points)
    ...
    /// </summary>
    public PolyBezier2D(params IEnumerable<PolyBezierContour2D> contours)
    {
        this.contours = contours as List<PolyBezierContour2D> ?? [];
    }
    ...
    /// </summary>
    /// <param name="contours"></param>
    public PolyBezier2D(params IEnumerable<List<Point2D>> contours)
    {
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public PolyBezier2D Clone() => new(Contours.ToArray());
