// <copyright file="PolyBezierContour2D.cs" >
...
namespace Engine
{
        ...
        : Shape2D
    {
        ...
        /// The items.
        /// </summary>
        private List<BezierSegmentX2D> items;
        ...
        /// </summary>
        public PolyBezierContour2D()
        {
            items = new List<BezierSegmentX2D>();
        }
        ...
        public PolyBezierContour2D(Point2D start)
        {
            items = new List<BezierSegmentX2D>
            {
                new BezierSegmentX2D(start)
            };
        }
        ...
        public PolyBezierContour2D(List<BezierSegmentX2D> items)
        {
            this.items = items;
        }
        ...
        /// </summary>
        /// <param name="items">The items.</param>
        public void Deconstruct(out List<BezierSegmentX2D> items)
            => items = this.items;
        ...
        /// <returns>One element of type BezierSegmentX2D.</returns>
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public BezierSegmentX2D this[int index]
                => items[index];
        #endregion Indexers
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public List<BezierSegmentX2D> Items
        {
            get { return items; }
            set
            {
        ...
        public override Rectangle2D Bounds
        {
            get
            {
                ...
                static Rectangle2D bounds(PolyBezierContour2D contour)
                {
        ...
        public static List<BezierSegmentX2D> ParsePathDefString(string pathDefinition)
        ...
        /// <returns>The <see cref="List{T}"/>.</returns>
        public static List<BezierSegmentX2D> ParsePathDefString(string pathDefinition, IFormatProvider provider)
        {
        ...
        public override string ConvertToString(string format, IFormatProvider provider)
            => (this is null) ? nameof(PolyBezierContour2D) : $"{nameof(PolyBezierContour2D)}{{{ToPathDefString(format, provider)}}}";
        #endregion Methods
    }
}
