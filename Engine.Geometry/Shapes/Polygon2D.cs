    ...
    : Shape2D, IEnumerable<PolygonContour2D>
{
    ...
    /// </summary>
    /// <param name="points"></param>
    public Polygon2D(params IEnumerable<Point2D> points)
    ...
    /// </summary>
    public Polygon2D(params IEnumerable<PolygonContour2D> contours)
    {
        this.contours = contours as List<PolygonContour2D> ?? [];
    }
    ...
    /// </summary>
    /// <param name="contours">The contours.</param>
    public Polygon2D(params IEnumerable<List<Point2D>> contours)
    {
        this.contours = new List<PolygonContour2D>() ?? throw new ArgumentNullException(nameof(contours), "Argument must not be null.");
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public Polygon2D Clone() => new(Contours.ToArray() as IEnumerable<PolygonContour2D>);
