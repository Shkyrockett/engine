    ...
    : Shape2D, IEnumerable<Point2D>
{
    ...
    /// </summary>
    /// <param name="points">The points.</param>
    public PolygonContour2D(params IEnumerable<Point2D> points)
    {
    ...
    public PolygonContour2D(params IEnumerable<Polyline2D> polylines)
    {
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public PolygonContour2D Clone() => new(points.ToArray());
