    ...
    : Shape2D, IEnumerable<Polyline2D>
{
    ...
    /// </summary>
    public PolylineSet2D(params IEnumerable<Polyline2D> polylines)
    {
        this.polylines = polylines as List<Polyline2D> ?? [];
    }
    ...
    /// </summary>
    /// <param name="polylines"></param>
    public PolylineSet2D(params IEnumerable<List<Point2D>> polylines)
    {
