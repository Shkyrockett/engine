    ...
    : Shape2D, IEquatable<QuadraticBezier2D>
{
    ...
    public Polynomial<double> CurveX
    {
        get
        {
            var curveX = (Polynomial<double>)CachingProperty(() => (Polynomial<double>)QuadraticBezierBernsteinBasis(cx, bx, ax));
    ...
    public Polynomial<double> CurveY
    {
        get
        {
            var curveY = (Polynomial<double>)CachingProperty(() => (Polynomial<double>)QuadraticBezierBernsteinBasis(cy, by, ay));
    ...
    //[DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public override Point2D Interpolate(double t) => new(Interpolators.QuadraticBezier(t, ax, ay, bx, by, cx, cy));
