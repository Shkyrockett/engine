    ...
    : IFillable, IEquatable<GradientFill>
{
    ...
    /// </returns>
    public readonly bool Equals([AllowNull] GradientFill other) => EqualityComparer<IColor>.Default.Equals(Color, other.Color) && EqualityComparer<Dictionary<double, IColor>>.Default.Equals(ColorStops, other.ColorStops) && FillMode == other.FillMode;
    ...
    /// </returns>
    public override readonly int GetHashCode() => HashCode.Combine(Color, ColorStops, FillMode);
}