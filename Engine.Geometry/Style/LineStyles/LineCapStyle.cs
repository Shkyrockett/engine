    ...
    : IFormattable, IEquatable<LineCapStyle>
{
    ...
    public PolycurveContour2D CapPath { readonly get { return capPath; } set { capPath = value; } }
    ...
    /// </returns>
    public readonly bool Equals([AllowNull] LineCapStyle other) => EqualityComparer<PolycurveContour2D>.Default.Equals(capPath, other.capPath);
    ...
    /// </returns>
    public override readonly int GetHashCode() => HashCode.Combine(capPath);
