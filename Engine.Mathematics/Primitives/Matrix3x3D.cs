    ...
    : IMatrix<Matrix3x3D, Vector3D>
{
    ...
    /// </summary>
    public static readonly Matrix3x3D Empty = new(
        0d, 0d, 0d,
        0d, 0d, 0d,
        0d, 0d, 0d);
    ...
    /// </summary>
    public static readonly Matrix3x3D Identity = new(
        1d, 0d, 0d,
        0d, 1d, 0d,
        0d, 0d, 1d);
    ...
    public Vector3D Cx { readonly get { return new Vector3D(M0x0, M1x0, M2x0); } set { (M0x0, M1x0, M2x0) = value; } }
    ...
    public Vector3D Cy { readonly get { return new Vector3D(M0x1, M1x1, M2x1); } set { (M0x1, M1x1, M2x1) = value; } }
    ...
    public Vector3D Cz { readonly get { return new Vector3D(M0x2, M1x2, M2x2); } set { (M0x2, M1x2, M2x2) = value; } }
    ...
    public Vector3D Rx { readonly get { return new Vector3D(M0x0, M0x1, M0x2); } set { (M0x0, M0x1, M0x2) = value; } }
    ...
    public Vector3D Ry { readonly get { return new Vector3D(M1x0, M1x1, M1x2); } set { (M1x0, M1x1, M1x2) = value; } }
    ...
    public Vector3D Rz { readonly get { return new Vector3D(M2x0, M2x1, M2x2); } set { (M2x0, M2x1, M2x2) = value; } }
    ...
    /// </value>
    [IgnoreDataMember, XmlIgnore, SoapIgnore]
    public readonly double Determinant => MatrixDeterminant(M0x0, M0x1, M0x2, M1x0, M1x1, M1x2, M2x0, M2x1, M2x2);
    ...
    /// </value>
    [IgnoreDataMember, XmlIgnore, SoapIgnore]
    public readonly Matrix3x3D Transposed => TransposeMatrix(M0x0, M0x1, M0x2, M1x0, M1x1, M1x2, M2x0, M2x1, M2x2);
    ...
    /// </value>
    [IgnoreDataMember, XmlIgnore, SoapIgnore]
    public readonly Matrix3x3D Adjoint => AdjointMatrix(M0x0, M0x1, M0x2, M1x0, M1x1, M1x2, M2x0, M2x1, M2x2);
    ...
    /// </value>
    [IgnoreDataMember, XmlIgnore, SoapIgnore]
    public readonly Matrix3x3D Cofactor => CofactorMatrix(M0x0, M0x1, M0x2, M1x0, M1x1, M1x2, M2x0, M2x1, M2x2);
    ...
    /// </value>
    [IgnoreDataMember, XmlIgnore, SoapIgnore]
    public readonly Matrix3x3D Inverted => InverseMatrix(M0x0, M0x1, M0x2, M1x0, M1x1, M1x2, M2x0, M2x1, M2x2);
    ...
    /// </value>
    [IgnoreDataMember, XmlIgnore, SoapIgnore]
    public readonly bool IsIdentity => IsMatrixIdentity(M0x0, M0x1, M0x2, M1x0, M1x1, M1x2, M2x0, M2x1, M2x2);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static explicit operator Matrix3x3D(Matrix2x2D source) => new(source.M0x0, source.M0x1, 0d, source.M1x0, source.M1x1, 0d, 0d, 0d, 1);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static implicit operator Matrix3x3D((double, double, double, double, double, double, double, double, double) tuple) => new(tuple);
    #endregion Operators
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly (double, double, double, double, double, double, double, double, double) ToValueTuple() => (M0x0, M0x1, M0x2, M1x0, M1x1, M1x2, M2x0, M2x1, M2x2);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Matrix3x3D FromValueTuple((double, double, double, double, double, double, double, double, double) tuple) => new(tuple);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly Matrix3x3D ToMatrix3x3D() => new(M0x0, M0x1, M0x2, M1x0, M1x1, M1x2, M2x0, M2x1, M2x2);
    #endregion
