    ...
    : IMatrix<Matrix4x4D, Vector4D>
{
    ...
    /// </summary>
    public static readonly Matrix4x4D Empty = new(
        0d, 0d, 0d, 0d,
        0d, 0d, 0d, 0d,
        0d, 0d, 0d, 0d,
        0d, 0d, 0d, 0d);
    ...
    public Vector4D Cx { readonly get { return new Vector4D(M0x0, M1x0, M2x0, M3x0); } set { (M0x0, M1x0, M2x0, M3x0) = value; } }
    ...
    public Vector4D Cy { readonly get { return new Vector4D(M0x1, M1x1, M2x1, M3x1); } set { (M0x1, M1x1, M2x1, M3x1) = value; } }
    ...
    public Vector4D Cz { readonly get { return new Vector4D(M0x2, M1x2, M2x2, M3x2); } set { (M0x2, M1x2, M2x2, M3x2) = value; } }
    ...
    public Vector4D Cw { readonly get { return new Vector4D(M0x3, M1x3, M2x3, M3x3); } set { (M0x3, M1x3, M2x3, M3x3) = value; } }
    ...
    public Vector4D Rx { readonly get { return new Vector4D(M0x0, M0x1, M0x2, M0x3); } set { (M0x0, M0x1, M0x2, M0x3) = value; } }
    ...
    public Vector4D Ry { readonly get { return new Vector4D(M1x0, M1x1, M1x2, M1x3); } set { (M1x0, M1x1, M1x2, M1x3) = value; } }
    ...
    public Vector4D Rz { readonly get { return new Vector4D(M2x0, M2x1, M2x2, M2x3); } set { (M2x0, M2x1, M2x2, M2x3) = value; } }
    ...
    public Vector4D Rw { readonly get { return new Vector4D(M3x0, M3x1, M3x2, M3x3); } set { (M3x0, M3x1, M3x2, M3x3) = value; } }
    ...
    /// </value>
    [IgnoreDataMember, XmlIgnore, SoapIgnore]
    public readonly double Determinant => MatrixDeterminant(M0x0, M0x1, M0x2, M0x3, M1x0, M1x1, M1x2, M1x3, M2x0, M2x1, M2x2, M2x3, M3x0, M3x1, M3x2, M3x3);
    ...
    /// </value>
    [IgnoreDataMember, XmlIgnore, SoapIgnore]
    public readonly Matrix4x4D Transposed => TransposeMatrix(M0x0, M0x1, M0x2, M0x3, M1x0, M1x1, M1x2, M1x3, M2x0, M2x1, M2x2, M2x3, M3x0, M3x1, M3x2, M3x3);
    ...
    /// </value>
    [IgnoreDataMember, XmlIgnore, SoapIgnore]
    public readonly Matrix4x4D Adjoint => AdjointMatrix(M0x0, M0x1, M0x2, M0x3, M1x0, M1x1, M1x2, M1x3, M2x0, M2x1, M2x2, M2x3, M3x0, M3x1, M3x2, M3x3);
    ...
    /// </value>
    [IgnoreDataMember, XmlIgnore, SoapIgnore]
    public readonly Matrix4x4D Cofactor => CofactorMatrix(M0x0, M0x1, M0x2, M0x3, M1x0, M1x1, M1x2, M1x3, M2x0, M2x1, M2x2, M2x3, M3x0, M3x1, M3x2, M3x3);
    ...
    /// </value>
    [IgnoreDataMember, XmlIgnore, SoapIgnore]
    public readonly Matrix4x4D Inverted => InverseMatrix(M0x0, M0x1, M0x2, M0x3, M1x0, M1x1, M1x2, M1x3, M2x0, M2x1, M2x2, M2x3, M3x0, M3x1, M3x2, M3x3);
    ...
    public readonly bool IsIdentity
        => Abs(M0x0 - 1) < double.Epsilon
            && Abs(M0x1) < double.Epsilon
            && Abs(M0x2) < double.Epsilon
            && Abs(M0x3) < double.Epsilon
            && Abs(M1x0) < double.Epsilon
            && Abs(M1x1 - 1) < double.Epsilon
            && Abs(M1x2) < double.Epsilon
            && Abs(M1x3) < double.Epsilon
            && Abs(M2x0) < double.Epsilon
            && Abs(M2x1) < double.Epsilon
            && Abs(M2x2 - 1) < double.Epsilon
            && Abs(M2x3) < double.Epsilon
            && Abs(M3x0) < double.Epsilon
            && Abs(M3x1) < double.Epsilon
            && Abs(M3x2) < double.Epsilon
            && Abs(M3x3 - 1) < double.Epsilon;
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static implicit operator Matrix4x4D((double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double) tuple) => new(tuple);
    #endregion Operators
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Vector4D Multiply(Matrix4x4D multiplicand, Vector4D multiplier) => MultiplyMatrix4x4ByVerticalVector4D(multiplicand.M0x0, multiplicand.M0x1, multiplicand.M0x2, multiplicand.M0x3, multiplicand.M1x0, multiplicand.M1x1, multiplicand.M1x2, multiplicand.M1x3, multiplicand.M2x0, multiplicand.M2x1, multiplicand.M2x2, multiplicand.M2x3, multiplicand.M3x0, multiplicand.M3x1, multiplicand.M3x2, multiplicand.M3x3, multiplier.I, multiplier.J, multiplier.K, multiplier.L);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Vector4D Multiply(Vector4D multiplicand, Matrix4x4D multiplier) => MultiplyHorizontalVector4DByMatrix4x4(multiplicand.I, multiplicand.J, multiplicand.K, multiplicand.L, multiplier.M0x0, multiplier.M0x1, multiplier.M0x2, multiplier.M0x3, multiplier.M1x0, multiplier.M1x1, multiplier.M1x2, multiplier.M1x3, multiplier.M2x0, multiplier.M2x1, multiplier.M2x2, multiplier.M2x3, multiplier.M3x0, multiplier.M3x1, multiplier.M3x2, multiplier.M3x3);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly (double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double) ToValueTuple() => (M0x0, M0x1, M0x2, M0x3, M1x0, M1x1, M1x2, M1x3, M2x0, M2x1, M2x2, M2x3, M3x0, M3x1, M3x2, M3x3);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Matrix4x4D FromValueTuple((double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double) tuple) => new(tuple);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly Matrix4x4D ToMatrix4x4D() => new(M0x0, M0x1, M0x2, M0x3, M1x0, M1x1, M1x2, M1x3, M2x0, M2x1, M2x2, M2x3, M3x0, M3x1, M3x2, M3x3);
    #endregion
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Matrix4x4D Parse(string source, IFormatProvider formatProvider)
    {
    ...
    public readonly IEnumerator<IEnumerable<double>> GetEnumerator()
        ...
        {
            new() { M0x0, M0x1, M0x2, M0x3 },
            new() { M1x0, M1x1, M1x2, M1x3 },
            new() { M2x0, M2x1, M2x2, M2x3 },
            new() { M3x0, M3x1, M3x2, M3x3 },
        }.GetEnumerator();
    ...
    /// <summary>
    /// Creates a string representation of this <see cref="Matrix4x4D" /> struct based on the current culture.
    /// </summary>
    /// <returns>
    /// A string representation of this <see cref="Matrix4x4D" />.
    /// </returns>
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    ...
    /// <summary>
    /// Creates a string representation of this <see cref="Matrix4x4D" /> struct based on the IFormatProvider
    ...
    /// <summary>
    /// Creates a string representation of this <see cref="Matrix4x4D" /> struct based on the format string
    ...
    public string ToString(string format, IFormatProvider formatProvider)
    {
        ...
        return $"{nameof(Matrix4x4D)}({nameof(M0x0)}:{M0x0.ToString(format, formatProvider)}{s} {nameof(M0x1)}:{M0x1.ToString(format, formatProvider)}{s} {nameof(M0x2)}:{M0x2.ToString(format, formatProvider)}{s} {nameof(M0x3)}:{M0x3.ToString(format, formatProvider)}{s} {nameof(M1x0)}:{M1x0.ToString(format, formatProvider)}{s} {nameof(M1x1)}:{M1x1.ToString(format, formatProvider)}{s} {nameof(M1x2)}:{M1x2.ToString(format, formatProvider)}{s} {nameof(M1x3)}:{M1x3.ToString(format, formatProvider)}{s} {nameof(M2x0)}:{M2x0.ToString(format, formatProvider)}{s} {nameof(M2x1)}:{M2x1.ToString(format, formatProvider)}{s} {nameof(M2x2)}:{M2x2.ToString(format, formatProvider)}{s} {nameof(M2x3)}:{M2x3.ToString(format, formatProvider)}{s} {nameof(M3x0)}:{M3x0.ToString(format, formatProvider)}{s} {nameof(M3x1)}:{M3x1.ToString(format, formatProvider)}{s} {nameof(M3x2)}:{M3x2.ToString(format, formatProvider)}{s} {nameof(M3x3)}:{M3x3.ToString(format, formatProvider)})";
    }
