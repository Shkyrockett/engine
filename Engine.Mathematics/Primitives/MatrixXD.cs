    ...
    : IMatrix<MatrixXD, VectorXD>
{
    ...
    /// <returns></returns>
    public readonly double this[int index1, int index2]
    {
    ...
    /// The rows.
    /// </value>
    public readonly int Rows => Values.Length;
    ...
    /// The columns.
    /// </value>
    public readonly int Columns => Values[0].Length;
    ...
    /// </value>
    public readonly bool IsSquare => IsSquareMatrix(Values);
    ...
    /// </value>
    public readonly bool IsIdentity => IsIdentity(Values);
    ...
    /// </value>
    public readonly bool IsLower => IsLowerMatrix(Values);
    ...
    /// </value>
    public readonly bool IsUpper => IsUpperMatrix(Values);

    /// <summary>
    /// The determinant
    /// </summary>
    public readonly double Determinant => Operations.Determinant(Values);
    ...
    /// </value>
    public readonly double InverseDeterminant => Operations.Determinant(Operations.Inverse(Values));
    ...
    /// The transpose.
    /// </value>
    public readonly MatrixXD Transpose => Operations.Transpose(Values);
    ...
    /// The inverse.
    /// </value>
    public readonly MatrixXD Inverse => Operations.Inverse(Values);
    ...
    /// The adjoint.
    /// </value>
    public readonly MatrixXD Adjoint => Operations.Adjoint(Values);
    ...
    /// The cofactor.
    /// </value>
    public readonly MatrixXD Cofactor => Operations.Cofactor(Values);
    ...
    /// The decompose.
    /// </value>
    public readonly (MatrixXD Lower, MatrixXD Upper) Decompose => DecomposeToLowerUpper(Values);
    #endregion
    ...
    /// </returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly bool Equals(MatrixXD other) => other is MatrixXD matrix && EqualityComparer<double[][]>.Default.Equals(Values, matrix.Values);
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static MatrixXD ToMatrix(double[,] array) => new(array);
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly double DotProduct(MatrixXD b) => Operations.DotProduct(Values, b.Values);
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly MatrixXD Lerp(MatrixXD b, double t) => Operations.Lerp(Values, b.Values, t);
