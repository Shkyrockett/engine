    ...
    : IEquatable<Rank3Tensor>
{
    ...
    /// <returns></returns>
    public readonly double this[int index1, int index2, int index3]
    {
    ...
    /// </returns>
    public readonly bool Equals(Rank3Tensor other) => EqualityComparer<double[,,]>.Default.Equals(Values, other.Values);
    ...
    private static Rank3Tensor ToRank3Tensor(double[,,] array) => new(array);
    #endregion
