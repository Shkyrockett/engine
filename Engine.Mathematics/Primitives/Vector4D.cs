    ...
    : IVector<Vector4D>
{
    ...
    /// </summary>
    public static readonly Vector4D XAxis = new(1d, 0d, 0d, 0d);
    ...
    /// </summary>
    public static readonly Vector4D YAxis = new(0d, 1d, 0d, 0d);
    ...
    /// </summary>
    public static readonly Vector4D ZAxis = new(0d, 0d, 1d, 0d);
    ...
    /// </summary>
    public static readonly Vector4D WAxis = new(0d, 0d, 0d, 1d);
    ...
    public readonly void Deconstruct(out double i, out double j, out double k, out double l) => (i, j, k, l) = (I, J, K, L);
    ...
    [Browsable(false)]
    public readonly bool IsEmpty => IsEmptyVector(I, J, K, L);
    ...
    [IgnoreDataMember, XmlIgnore, SoapIgnore]
    [Browsable(false)]
    public readonly double Magnitude => VectorMagnitude(I, J, K, L);
    ...
    [IgnoreDataMember, XmlIgnore, SoapIgnore]
    [Browsable(false)]
    public readonly double Length => VectorMagnitude(I, J, K, L);
    ...
    [IgnoreDataMember, XmlIgnore, SoapIgnore]
    [Browsable(false)]
    public readonly double LengthSquared => VectorMagnitudeSquared(I, J, K, L);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static implicit operator Vector4D((double X, double Y, double Z, double W) tuple) => new(tuple);
    #endregion Operators
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly Vector4D Plus() => Operations.Plus(I, J, K, L);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly Vector4D Add(double addend) => AddVectorUniform(I, J, K, L, addend);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly Vector4D Add(Vector4D addend) => AddVectors(I, J, K, L, addend.I, addend.J, addend.K, addend.L);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly Vector4D Negate() => Operations.Negate(I, J, K, L);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly Vector4D Subtract(double subend) => SubtractVectorUniform(I, J, K, L, subend);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly Vector4D Subtract(Vector4D subend) => SubtractVector(I, J, K, L, subend.I, subend.J, subend.K, subend.L);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly Vector4D Multiply(double multiplier) => ScaleVector(I, J, K, L, multiplier);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly Vector4D Divide(double divisor) => DivideVectorUniform(I, J, K, L, divisor);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly double DotProduct(Vector4D right) => Operations.DotProduct(I, J, K, L, right.I, right.J, right.K, right.L);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly bool Equals([AllowNull] Vector4D other) => I == other.I && J == other.J && K == other.K && L == other.L;
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly (double I, double J, double K, double L) ToValueTuple() => (I, J, K, L);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Vector4D FromValueTuple((double X, double Y, double Z, double W) tuple) => new(tuple);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly Vector4D ToVector4D() => new(I, J, K, L);
    #endregion
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public override readonly int GetHashCode() => HashCode.Combine(I, J, K, L);
