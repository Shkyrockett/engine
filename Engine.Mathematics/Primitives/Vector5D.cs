    ...
    : IVector<Vector5D>
{
    ...
    /// </summary>
    public static readonly Vector5D XAxis = new(1d, 0d, 0d, 0d, 0d);
    ...
    /// </summary>
    public static readonly Vector5D YAxis = new(0d, 1d, 0d, 0d, 0d);
    ...
    /// </summary>
    public static readonly Vector5D ZAxis = new(0d, 0d, 1d, 0d, 0d);
    ...
    /// </summary>
    public static readonly Vector5D WAxis = new(0d, 0d, 0d, 1d, 0d);
    ...
    /// </summary>
    public static readonly Vector5D VAxis = new(0d, 0d, 0d, 0d, 1d);
    ...
    public readonly void Deconstruct(out double i, out double j, out double k, out double l, out double m) => (i, j, k, l, m) = (I, J, K, L, M);
    ...
    [Browsable(false)]
    public readonly bool IsEmpty => IsEmptyVector(I, J, K, L, M);
    ...
    [IgnoreDataMember, XmlIgnore, SoapIgnore]
    [Browsable(false)]
    public readonly double Magnitude => VectorMagnitude(I, J, K, L, M);
    ...
    [IgnoreDataMember, XmlIgnore, SoapIgnore]
    [Browsable(false)]
    public readonly double Length => VectorMagnitude(I, J, K, L, M);
    ...
    [IgnoreDataMember, XmlIgnore, SoapIgnore]
    [Browsable(false)]
    public readonly double LengthSquared => VectorMagnitudeSquared(I, J, K, L, M);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static implicit operator Vector5D((double X, double Y, double Z, double W, double V) tuple) => new(tuple);
    #endregion Operators
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly Vector5D Plus() => Operations.Plus(I, J, K, L, M);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly Vector5D Add(double addend) => AddVectorUniform(I, J, K, L, M, addend);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly Vector5D Add(Vector5D addend) => AddVectors(I, J, K, L, M, addend.I, addend.J, addend.K, addend.L, addend.M);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly Vector5D Negate() => Operations.Negate(I, J, K, L, M);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly Vector5D Subtract(double subend) => SubtractVectorUniform(I, J, K, L, M, subend);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly Vector5D Subtract(Vector5D subend) => SubtractVector(I, J, K, L, M, subend.I, subend.J, subend.K, subend.L, subend.M);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly Vector5D Multiply(double multiplier) => ScaleVector(I, J, K, L, M, multiplier);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly Vector5D Divide(double divisor) => DivideVectorUniform(I, J, K, L, M, divisor);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly double DotProduct(Vector5D right) => Operations.DotProduct(I, J, K, L, M, right.I, right.J, right.K, right.L, right.M);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly bool Equals([AllowNull] Vector5D other) => I == other.I && J == other.J && K == other.K && L == other.L && L == other.M;
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly (double I, double J, double K, double L, double M) ToValueTuple() => (I, J, K, L, M);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Vector5D FromValueTuple((double X, double Y, double Z, double W, double V) tuple) => new(tuple);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly Vector5D ToVector5D() => new(I, J, K, L, M);
    #endregion
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public override readonly int GetHashCode() => HashCode.Combine(I, J, K, L, M);
