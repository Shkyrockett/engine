    ...
    : EventStatus
{
    ...
    /// </returns>
    internal static new EndOfTrack Read(BinaryReaderExtended reader, IEventStatus status) => new(status, reader.Position == reader.Length ? 0 : reader.ReadVariableLengthInt());
