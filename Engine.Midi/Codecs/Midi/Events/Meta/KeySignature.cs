    ...
    : EventStatus
{
    ...
    /// </returns>
    internal static new KeySignature Read(BinaryReaderExtended reader, IEventStatus status) => new(status, reader.ReadVariableLengthInt(), (MidiKeySignature)reader.ReadByte(), (MidiTonality)reader.ReadByte());
