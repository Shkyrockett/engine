    ...
    : EventStatus
{
    ...
    /// </returns>
    internal static new SequenceNumber Read(BinaryReaderExtended reader, IEventStatus status) => new(status, reader.ReadVariableLengthInt(), reader.ReadNetworkInt16());
