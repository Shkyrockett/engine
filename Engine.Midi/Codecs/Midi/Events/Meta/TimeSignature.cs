    ...
    : EventStatus
{
    ...
    /// </returns>
    internal static new TimeSignature Read(BinaryReaderExtended reader, IEventStatus status) => new(status, reader.ReadVariableLengthInt(), reader.ReadByte(), reader.ReadByte(), reader.ReadByte(), reader.ReadByte());
