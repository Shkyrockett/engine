...
namespace Engine.Midi
{
        ...
        : IMediaContainer
    {
        ...
        {
            using (var reader = new MidiBinaryReader(stream))
                return Read(reader);
        }
        ...
        /// <returns></returns>
        internal static Midi Read(MidiBinaryReader reader)
        {
            Midi midi = null;
            ...
            //using (
            var headerReader = new MidiBinaryReader(headerChunk.SubStream);//)
            {
            ...
            for (var i = 0; i < header.TrackCount; i++)
            {
                ...
                //using (
                var trackReader = new MidiBinaryReader(trackChunk.SubStream);//)
                {
