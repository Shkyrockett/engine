...
internal static partial class Interop
{
    internal static partial class Winmm
    {
        ...
        /// </summary>
        /// <param name="hMidiOut">Identifier of the MIDI device that receives the message. You must cast the device ID to the HMIDIOUT handle type. If you supply a handle instead of a device ID, the function fails and returns the MMSYSERR_NOSUPPORT error code.</param>
