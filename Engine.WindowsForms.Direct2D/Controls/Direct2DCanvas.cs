    ...
    : UserControl
{
    ...
    public void Render()
    {
        ...
        {
            target.FillRectangle(new SharpDX.RectangleF(i * bandWidth, target.Size.Height * bandPercentage / 100, bandWidth - gap, target.Size.Height - (target.Size.Height * bandPercentage / 100)), bandBrush);
            i++;
        }
    ...
    private void CreateBandBrush()
    {
        ...
        using var points = new GradientStopCollection(target, [
            new() {Color=SharpDX.Color.Green, Position=0F},
            new() {Color=SharpDX.Color.Yellow, Position=0.8F},
            new() {Color=SharpDX.Color.Red, Position=1F}
        ], ExtendMode.Clamp);
