...
public static class PointExtentions
{
    ...
    public static double AbsoluteAngle(this Point pointA, Point pointB) => Operations.AbsoluteAngle((double)pointA.X, pointA.Y, pointB.X, pointB.Y);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Point Add(this Point point, int addend) => new(point.X + addend, point.Y + addend);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Point Add(this Point point, float addend) => new((int)(point.X + addend), (int)(point.Y + addend));
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Point Add(this Point point, double addend) => new((int)(point.X + addend), (int)(point.Y + addend));
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Point Add(this Point point, Point addend) => new(point.X + addend.X, point.Y + addend.Y);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Point Add(this Point point, PointF addend) => new((int)(point.X + addend.X), (int)(point.Y + addend.Y));
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Point Add(this Point point, Size addend) => new(point.X + addend.Width, point.Y + addend.Height);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Point Add(this Point point, SizeF addend) => new((int)(point.X + addend.Width), (int)(point.Y + addend.Height));
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Point Add(this Point point, Vector2D addend) => new((int)(point.X + addend.I), (int)(point.Y + addend.J));
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static double Angle(this Point PointA, Point PointB) => Operations.Angle((double)PointA.X, PointA.Y, PointB.X, PointB.Y);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Point Inflate(this Point point, int factor) => new(point.X * factor, point.Y * factor);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Point Inflate(this Point point, float factor) => new((int)(point.X * factor), (int)(point.Y * factor));
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Point Inflate(this Point point, double factor) => new((int)(point.X * factor), (int)(point.Y * factor));
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Point Inflate(this Point point, Point factors) => new(point.X * factors.X, point.Y * factors.Y);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Point Inflate(this Point point, PointF factors) => new((int)(point.X * factors.X), (int)(point.Y * factors.Y));
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Point Inflate(this Point size, Size factor) => new(size.X * factor.Width, size.Y * factor.Height);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Point Inflate(this Point point, SizeF factor) => new((int)(point.X * factor.Width), (int)(point.Y * factor.Height));
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Point Inflate(this Point point, Vector2D factors) => new((int)(point.X * factors.I), (int)(point.Y * factors.J));
    ...
    /// <returns>Returns a <see cref="Point"/> structure inflated by the factor provided.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Point Scale(int x, int y, int factor) => new(x * factor, y * factor);
    ...
    /// <returns>Returns a <see cref="Point"/> structure inflated by the factor provided.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Point Scale(int x, int y, float factor) => new((int)(x * factor), (int)(y * factor));
    ...
    /// <returns>Returns a <see cref="Point"/> structure inflated by the factor provided.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static Point Scale(int x, int y, double factor) => new((int)(x * factor), (int)(y * factor));
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static double Slope(this Point PointA, Point PointB) => Operations.Slope((double)PointA.X, PointA.Y, PointB.X, PointB.Y);
    ...
    /// <returns>Returns a <see cref="PointF"/> structure inflated by the factor provided.</returns>
    public static Point Subtract(this Point point, int value) => new(point.X - value, point.Y - value);
    ...
    /// <param name="value">The factor to inflate the <see cref="PointF"/>.</param>
    /// <returns>Returns a <see cref="PointF"/> structure inflated by the factor provided.</returns>
    public static Point Subtract(this Point point, float value) => new((int)(point.X - value), (int)(point.Y - value));
    ...
    /// <param name="value">The factor to inflate the <see cref="PointF"/>.</param>
    /// <returns>Returns a <see cref="PointF"/> structure inflated by the factor provided.</returns>
    public static Point Subtract(this Point point, double value) => new((int)(point.X - value), (int)(point.Y - value));
    ...
    public static Point Subtract(this Point point, Size value) => new(point.X - value.Width, point.Y - value.Height);
    ...
    public static Point Subtract(this Point point, SizeF value) => new((int)(point.X - value.Width), (int)(point.Y - value.Height));
    ...
    public static Point Subtract(this Point point, Vector2D value) => new((int)(point.X - value.I), (int)(point.Y - value.J));
