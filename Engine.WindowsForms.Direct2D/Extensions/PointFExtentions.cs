...
namespace Engine
{
    ...
    public static class PointFExtentions
    {
        ...
        [DebuggerStepThrough]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PointF Inflate(this PointF point, int factor) => new PointF(point.X * factor, point.Y * factor);
        ...
        [DebuggerStepThrough]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PointF Inflate(this PointF point, float factor) => new PointF(point.X * factor, point.Y * factor);
        ...
        [DebuggerStepThrough]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PointF Inflate(this PointF point, double factor) => new PointF((float)(point.X * factor), (float)(point.Y * factor));
        ...
        [DebuggerStepThrough]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PointF Inflate(this PointF point, Point factors) => new PointF(point.X * factors.X, point.Y * factors.Y);
        ...
        [DebuggerStepThrough]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PointF Inflate(this PointF point, PointF factors) => new PointF(point.X * factors.X, point.Y * factors.Y);
        ...
        [DebuggerStepThrough]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PointF Inflate(this PointF size, Size factor) => new PointF(size.X * factor.Width, size.Y * factor.Height);
        ...
        [DebuggerStepThrough]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PointF Inflate(this PointF point, SizeF factor) => new PointF(point.X * factor.Width, point.Y * factor.Height);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PointF Scale(float x, float y, float factor) => new PointF(x * factor, y * factor);
        ...
        /// <returns>Returns a <see cref="PointF"/> structure inflated by the factor provided.</returns>
        public static PointF Subtract(this PointF point, int value) => new PointF(point.X - value, point.Y - value);
        ...
        /// <param name="value">The factor to inflate the <see cref="PointF"/>.</param>
        /// <returns>Returns a <see cref="PointF"/> structure inflated by the factor provided.</returns>
        public static PointF Subtract(this PointF point, float value) => new PointF(point.X - value, point.Y - value);
        ...
        /// <param name="value">The factor to inflate the <see cref="PointF"/>.</param>
        /// <returns>Returns a <see cref="PointF"/> structure inflated by the factor provided.</returns>
        public static PointF Subtract(this PointF point, double value) => new PointF((float)(point.X - value), (float)(point.Y - value));
        ...
        /// <param name="value">The factor to inflate the <see cref="PointF"/>.</param>
        /// <returns>Returns a <see cref="PointF"/> structure inflated by the factor provided.</returns>
        public static Vector2D Subtract(this PointF point, Point value) => new Vector2D(point.X - value.X, point.Y - value.Y);
        ...
        /// <param name="value">The factor to inflate the <see cref="PointF"/>.</param>
        /// <returns>Returns a <see cref="PointF"/> structure inflated by the factor provided.</returns>
        public static Vector2D Subtract(this PointF point, PointF value) => new Vector2D(point.X - value.X, point.Y - value.Y);
        ...
        public static PointF Subtract(this PointF point, Size value) => new PointF(point.X - value.Width, point.Y - value.Height);
        ...
        public static PointF Subtract(this PointF point, SizeF value) => new PointF(point.X - value.Width, point.Y - value.Height);
        ...
        public static PointF Subtract(this PointF point, Vector2D Value) => new PointF((float)(point.X - Value.I), (float)(point.Y - Value.J));
