...
public static class DrawingExtensions
{
    ...
    public static RGBA ToRGBA(this Color color) => new(color.R, color.G, color.B, color.A, color.Name);
    ...
    public static Pen ToPen(this IStroke pen) => new((pen?.Fill).Color.ToColor());//new Pen(pen.Brush.ToBrush());
    ...
    public static WinformsRenderer ToWinformsRenderer(this Graphics graphics) => new(graphics);
}
