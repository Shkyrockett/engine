...
public static class RectangleFExtensions
{
    ...
    public static PointF Center(this RectangleF rectangle) => new(
    ...
    public static RectangleF RectangleFFromCenter(PointF center, SizeF size) => new(PointF.Subtract(center, size.Inflate(0.5f)), size);
