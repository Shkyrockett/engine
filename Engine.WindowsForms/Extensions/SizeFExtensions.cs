...
public static class SizeFExtensions
{
    ...
    public static SizeF Inflate(this SizeF size, double factor)
        => new((float)(size.Width * factor), (float)(size.Height * factor));
    ...
    public static SizeF Inflate(this SizeF size, Point factor)
        => new(size.Width * factor.X, size.Height * factor.Y);
    ...
    public static SizeF Inflate(this SizeF size, Vector2D factor)
        => new((float)(size.Width * factor.I), (float)(size.Height * factor.J));
