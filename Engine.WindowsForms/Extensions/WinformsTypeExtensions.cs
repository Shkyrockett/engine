...
namespace Engine.Imaging
{
    ...
    public static class WinformsTypeExtensions
    {
        ...
        /// The <see cref="Point" />.
        /// </returns>
        public static Point ToPoint(this Point2D point) => new Point((int)point.X, (int)point.Y);
        ...
        /// The <see cref="PointF" />.
        /// </returns>
        public static PointF ToPointF(this Point2D point) => new PointF((float)point.X, (float)point.Y);
        ...
        /// The <see cref="Size" />.
        /// </returns>
        public static Size ToSize(this Size2D point) => new Size((int)point.Width, (int)point.Height);
        ...
        /// The <see cref="SizeF" />.
        /// </returns>
        public static SizeF ToSizeF(this Size2D point) => new SizeF((float)point.Width, (float)point.Height);
        ...
        /// </returns>
        public static Rectangle ToRectangle(this Rectangle2D rectangle) => new Rectangle((int)rectangle?.X, (int)rectangle.Y, (int)rectangle.Width, (int)rectangle.Height);
        ...
        /// </returns>
        public static RectangleF ToRectangleF(this Rectangle2D rectangle) => new RectangleF((float)rectangle?.X, (float)rectangle.Y, (float)rectangle.Width, (float)rectangle.Height);
        ...
        /// The <see cref="Font" />.
        /// </returns>
        public static Font ToFont(this RenderFont font) => new Font(font?.Name, (float)font.Size, (FontStyle)font.Style);
        ...
        /// </returns>
        public static RenderFont ToRenderFont(this Font font) => new RenderFont(font?.Name, font.Size, (TextStyles)font.Style);
        ...
        /// </returns>
        public static StringFormat ToStringFormat(this TextFormat stringFormat) => new StringFormat((StringFormatFlags)stringFormat?.Format, stringFormat.Language);
        ...
        /// </returns>
        public static TextFormat ToTextFormat(this StringFormat stringFormat) => new TextFormat((TextBoxFormatFlags)stringFormat?.FormatFlags, stringFormat.DigitSubstitutionLanguage);
    }
}
