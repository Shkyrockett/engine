...
namespace Engine.Chrono
{
    ...
    public partial class Occasion
    {
        ...
        public static Occasion OrthodoxEaster(int year, Culture culture)
        {
        ...
        private static DateTime CalculateEquinoxSolsticeDate(int year, Season season, Culture culture)
        {
            ...
            int hour = (int)(ut * 24);
            int minute = (int)((ut * 24 - hour) * 60);  //  Accurate to about 15 minutes c. 2000 CE.
            int second = (int)((((ut * 24 - hour) * 60) - minute) * 60);
