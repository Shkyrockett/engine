...
namespace Engine.File
{
    ...
    public static class FileEx
    {
        ...
        public static long HostToNetworkOrder(long host) => ((HostToNetworkOrder((int)host) & 0xffffffffL) << 0x20) | (HostToNetworkOrder((int)(host >> 0x20)) & 0xffffffffL);
        ...
        public static int HostToNetworkOrder(int host) => (((HostToNetworkOrder((short)host) & 0xffff) << 0x10) | (HostToNetworkOrder((short)(host >> 0x10)) & 0xffff));
        ...
        public static short HostToNetworkOrder(short host) => (short)(((host & 0xff) << 8) | ((host >> 8) & 0xff));
        ...
        /// <param name="host">The number to convert, expressed in host byte order. </param>
        /// <returns>A long value, expressed in network byte order.</returns>
        public static ulong HostToNetworkOrder(ulong host) => (ulong)(((HostToNetworkOrder((uint)host) & 0xffffffffL) << 0x20) | (HostToNetworkOrder((uint)(host >> 0x20)) & 0xffffffffL));
        ...
        /// <param name="host">The number to convert, expressed in host byte order. </param>
        /// <returns>An integer value, expressed in network byte order.</returns>
        public static uint HostToNetworkOrder(uint host) => (ushort)(((HostToNetworkOrder((ushort)host) & 0xffff) << 0x10) | (HostToNetworkOrder((ushort)(host >> 0x10)) & 0xffff));
        ...
        /// <param name="host">The number to convert, expressed in host byte order. </param>
        /// <returns>A short value, expressed in network byte order.</returns>
        public static ushort HostToNetworkOrder(ushort host) => (ushort)(((host & 0xff) << 8) | ((host >> 8) & 0xff));
        ...
        /// <param name="n"></param>
        /// <returns></returns>
        public static int HighWord(int n) => (n >> 16) & 0xffff;
