...
namespace Engine._Preview
{
    ...
    public class DistortionService
    {
        ...
        /// 
        /// </summary>
        private readonly GeometryPath source;
        ...
        public DistortionService(IDistortion distortion, GeometryPath source, float flatness = .2f)
        {
        ...
        public GeometryPath ApplyDistortion()
        {
        ...
        /// </summary>
        /// <param name="gp"></param>
        private void InjectPrecisionPoints(GeometryPath gp)
        {
