...
public class IntersectionsTests
{
    ...
    public void CubicBezierSegmentSelfIntersectionTest()
    {
        ...
        {
            var result = Intersections.CubicBezierSegmentSelfIntersection(test.Key.AX, test.Key.AY, test.Key.BX, test.Key.BY, test.Key.CX, test.Key.CY, test.Key.DX, test.Key.DY, double.Epsilon);
