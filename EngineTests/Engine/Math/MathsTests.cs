...
namespace Engine.Tests
{
    ...
    public class MathsTests
    {
        ...
        {
            Assert.AreEqual(false, Maths.IsOne(0d));
            Assert.AreEqual(true, Maths.IsOne(1d));
            Assert.AreEqual(false, Maths.IsOne(0.5d));
            Assert.AreEqual(false, Maths.IsOne(2d));
        }
        ...
        {
            Assert.AreEqual(true, Maths.IsZero(0d));
            Assert.AreEqual(false, Maths.IsZero(1d));
            Assert.AreEqual(false, Maths.IsZero(0.5d));
            Assert.AreEqual(false, Maths.IsZero(2d));
        }
        ...
        {
            Assert.AreEqual(true, Maths.LessThan(0d, 1d));
            Assert.AreEqual(false, Maths.LessThan(1d, 1d));
            Assert.AreEqual(true, Maths.LessThan(0.5d, 1d));
            Assert.AreEqual(false, Maths.LessThan(2d, 1d));
        }
        ...
        {
            Assert.AreEqual(true, Maths.LessThanOrClose(0d, 1d));
            Assert.AreEqual(true, Maths.LessThanOrClose(1d, 1d));
            Assert.AreEqual(true, Maths.LessThanOrClose(0.5d, 1d));
            Assert.AreEqual(false, Maths.LessThanOrClose(2d, 1d));
        }
        ...
        {
            Assert.AreEqual(false, Maths.GreaterThan(0d, 1d));
            Assert.AreEqual(false, Maths.GreaterThan(1d, 1d));
            Assert.AreEqual(false, Maths.GreaterThan(0.5d, 1d));
            Assert.AreEqual(true, Maths.GreaterThan(2d, 1d));
        }
        ...
        {
            Assert.AreEqual(false, Maths.GreaterThanOrClose(0d, 1d));
            Assert.AreEqual(true, Maths.GreaterThanOrClose(1d, 1d));
            Assert.AreEqual(false, Maths.GreaterThanOrClose(0.5d, 1d));
            Assert.AreEqual(true, Maths.GreaterThanOrClose(2d, 1d));
        }
        ...
        {
            Assert.AreEqual(false, Maths.IsBetweenZeroAndOne(-1d));
            Assert.AreEqual(true, Maths.IsBetweenZeroAndOne(0d));
            Assert.AreEqual(true, Maths.IsBetweenZeroAndOne(0.25d));
            Assert.AreEqual(true, Maths.IsBetweenZeroAndOne(0.5d));
            Assert.AreEqual(true, Maths.IsBetweenZeroAndOne(0.75d));
            Assert.AreEqual(true, Maths.IsBetweenZeroAndOne(1d));
            Assert.AreEqual(false, Maths.IsBetweenZeroAndOne(2d));
        }
