...
public class OperationsTests
{
    ...
    [Priority(0)]
    [Owner("Shkyrockett")]
    [TestProperty(nameof(Engine), nameof(Polynomial<double>))]
    [DeploymentItem("Engine.dll")]
    public void LinearBezierCoefficientsTest()
    {
        var expected = new Polynomial<double>(1, 1);
        var result = (Polynomial<double>)LinearBezierBernsteinBasis(1, 2);
    ...
    {
        var expected = new Polynomial<double>(0, 2, 1);
        var result = (Polynomial<double>)QuadraticBezierBernsteinBasis(1, 2, 3);
        Assert.AreEqual(expected, result);
    }
    ...
    {
        var expected = new Polynomial<double>(0, 0, 3, 1);
        var result = (Polynomial<double>)CubicBezierBernsteinBasis(1, 2, 3, 4);
        Assert.AreEqual(expected, result);
    }
    ...
    {
        var expected = new Polynomial<double>(0, 0, 0, 4, 1);
        var result = (Polynomial<double>)QuarticBezierBernsteinBasis(1, 2, 3, 4, 5);
        Assert.AreEqual(expected, result);
    }
    ...
    {
        var expected = new Polynomial<double>(0, 0, 0, 0, 5, 1);
    ...
    {
        var value = Operations.DegreesToRadians(0d);
        Assert.AreEqual(0, value);
        value = Operations.DegreesToRadians(30d);
        Assert.AreEqual(30 * (Math.PI / 180f), value);
        value = Operations.DegreesToRadians(45d);
        Assert.AreEqual(45 * (Math.PI / 180f), value);
        value = Operations.DegreesToRadians(60d);
        Assert.AreEqual(60 * (Math.PI / 180f), value);
        value = Operations.DegreesToRadians(90d);
        Assert.AreEqual(90 * (Math.PI / 180f), value);
        value = Operations.DegreesToRadians(120d);
        Assert.AreEqual(120 * (Math.PI / 180f), value);
        value = Operations.DegreesToRadians(135d);
        Assert.AreEqual(135 * (Math.PI / 180f), value);
        value = Operations.DegreesToRadians(150d);
        Assert.AreEqual(150 * (Math.PI / 180f), value);
        value = Operations.DegreesToRadians(180d);
        Assert.AreEqual(180 * (Math.PI / 180f), value);
        value = Operations.DegreesToRadians(210d);
        Assert.AreEqual(210 * (Math.PI / 180f), value);
        value = Operations.DegreesToRadians(225d);
        Assert.AreEqual(225 * (Math.PI / 180f), value);
        value = Operations.DegreesToRadians(240d);
        Assert.AreEqual(240 * (Math.PI / 180f), value);
        value = Operations.DegreesToRadians(270d);
        Assert.AreEqual(270 * (Math.PI / 180f), value);
        value = Operations.DegreesToRadians(300d);
        Assert.AreEqual(300 * (Math.PI / 180f), value);
        value = Operations.DegreesToRadians(315d);
        Assert.AreEqual(315 * (Math.PI / 180f), value);
        value = Operations.DegreesToRadians(330d);
        Assert.AreEqual(330 * (Math.PI / 180f), value);
        value = Operations.DegreesToRadians(360d);
    ...
    {
        var value = Operations.RadiansToDegrees(0d);
        Assert.AreEqual(0, value);
        value = Operations.RadiansToDegrees(30d);
        Assert.AreEqual(30 * (180f / Math.PI), value);
        value = Operations.RadiansToDegrees(45d);
        Assert.AreEqual(45 * (180f / Math.PI), value);
        value = Operations.RadiansToDegrees(60d);
        Assert.AreEqual(60 * (180f / Math.PI), value);
        value = Operations.RadiansToDegrees(90d);
        Assert.AreEqual(90 * (180f / Math.PI), value);
        value = Operations.RadiansToDegrees(120d);
        Assert.AreEqual(120 * (180f / Math.PI), value);
        value = Operations.RadiansToDegrees(135d);
        Assert.AreEqual(135 * (180f / Math.PI), value);
        value = Operations.RadiansToDegrees(150d);
        Assert.AreEqual(150 * (180f / Math.PI), value);
        value = Operations.RadiansToDegrees(180d);
        Assert.AreEqual(180 * (180f / Math.PI), value);
        value = Operations.RadiansToDegrees(210d);
        Assert.AreEqual(210 * (180f / Math.PI), value);
        value = Operations.RadiansToDegrees(225d);
        Assert.AreEqual(225 * (180f / Math.PI), value);
        value = Operations.RadiansToDegrees(240d);
        Assert.AreEqual(240 * (180f / Math.PI), value);
        value = Operations.RadiansToDegrees(270d);
        Assert.AreEqual(270 * (180f / Math.PI), value);
        value = Operations.RadiansToDegrees(300d);
        Assert.AreEqual(300 * (180f / Math.PI), value);
        value = Operations.RadiansToDegrees(315d);
        Assert.AreEqual(315 * (180f / Math.PI), value);
        value = Operations.RadiansToDegrees(330d);
        Assert.AreEqual(330 * (180f / Math.PI), value);
        value = Operations.RadiansToDegrees(360d);
