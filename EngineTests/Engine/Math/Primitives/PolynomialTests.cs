...
public class PolynomialTests
{
    ...
    {
        var cases = new Dictionary<Polynomial<double>, Polynomial<double>>
        {
            {new Polynomial<double>(0d), new Polynomial<double>(0d)},
            {new Polynomial<double>(2d, 0d, 25d, 0d, 4d, 0d), new Polynomial<double>(2d, 0d, 25d, 0d, 4d, 0d)},
            {new Polynomial<double>(0d, 5d, 25d, 0d, 4d, 0d), new Polynomial<double>(5d, 25d, 0d, 4d, 0d)},
            {new Polynomial<double>(0d, 0d, 25d, 0d, 4d, 0d), new Polynomial<double>(25d, 0d, 4d, 0d)},
            {new Polynomial<double>(0d, 0d, 0d, 8d, 4d, 0d), new Polynomial<double>(8d, 4d, 0d)},
            {new Polynomial<double>(0d, 0d, 0d, 0d, 4d, 0d), new Polynomial<double>(4d, 0d)},
            {new Polynomial<double>(0d, 0d, 0d, 0d, 0d, 1d), new Polynomial<double>(1d)},
            {new Polynomial<double>(1d, 0d, 0d, 0d, 0d, 0d), new Polynomial<double>(1d, 0d, 0d, 0d, 0d, 0d)},
        };
    ...
    {
        var value = new Polynomial<double>(0, 5, 25, 0, 4, 0);
        var expected = new Polynomial<double>(0, 20, 75, 0, 4);
    ...
    {
        var value = new Polynomial<double>(0, 5, 25, 0, 4, 0);
        var expected = new Polynomial<double>(1, 5, 0, 0.8, 0);
    ...
    {
        var value = new Polynomial<double>(0, 5, 25, 0, 4, 0);
        var expected = new Polynomial<double>(0, 1, 6.25, 0, 2, 0, 0);
    ...
    {
        var value = new Polynomial<double>(0, 5, 25, 0, 4, 0);
        var expected = new Polynomial<double>(0, 0, 25, 250, 625, 40, 200, 0, 16, 0, 0);
    ...
    {
        var value = new Polynomial<double>(1, 2, 3, 4, 5);
        var expected = (5, 15);
    ...
    {
        var expected = new Polynomial<double>[] { new(1), new(1, 0) };
        var result = Polynomial<double>.GetStandardBase(2);
    ...
    {
        var expected = new Polynomial<double>(1, 0, 0, 0);
        var result = Polynomial<double>.Term(PolynomialDegree.Cubic);
        Assert.AreEqual(expected, result);
    }
    ...
    public void InterpolateTest()
    {
        ...
        var result = Polynomial<double>.Interpolate(value);
        Assert.AreEqual(expected, result);
    }
    ...
    {
        var expected = new Polynomial<double>(1, 0, 0, 0);
        var result = Polynomial<double>.Monomial(PolynomialDegree.Cubic);
        Assert.AreEqual(expected, result);
    }
    ...
    {
        var value = new Polynomial<double>(1, 2, 3, 4, 5, 6, 7, 8, 9);
    ...
    {
        var value = new Polynomial<double>(12, 9, 6, 3, 0);
    ...
    {
        var value = new Polynomial<double>(1, 2, 3, 4, 5, 6);
        var expected = new Complex[] { new(-0.805786469389031, -1.22290471337441), new(0.551685463458982, -1.25334886027721), new(0.551685463458982, 1.25334886027721), new(-0.805786469389031, 1.22290471337441), new(-1.4917979881399, -1.42626051663959E-26) };
