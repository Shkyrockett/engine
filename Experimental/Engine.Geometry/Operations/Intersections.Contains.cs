...
namespace Engine
{
    ...
    public static partial class Intersections
    {
        ...
        [DebuggerStepThrough]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Inclusion Contains(this LineSegment2D seg, Point2D point)
        ...
        [DebuggerStepThrough]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Inclusion Contains(this PolygonContour2D polygon, Point2D point)
        ...
        [DebuggerStepThrough]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Inclusion Contains(this Circle2D circle, Point2D point)
        ...
        [DebuggerStepThrough]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Inclusion Contains(this Ellipse2D ellipse, Point2D point)
            => EllipseContainsPoint(ellipse.Center.X, ellipse.Center.Y, ellipse.RadiusA, ellipse.RadiusB, ellipse.CosAngle, ellipse.SinAngle, point.X, point.Y);
        ...
        [DebuggerStepThrough]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Inclusion Contains(this CircularArc2D arc, Point2D point)
        ...
        [DebuggerStepThrough]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Inclusion Contains(this EllipticalArc2D ellipseArc, Point2D point)
        ...
        public static bool PointInTriangle(
            LineSegment2D s, Point2D o, Point2D p,
            ...
            double epsilon = Epsilon)
        {
            ...
            var clockwise = CrossProduct(b - a, p - b) >= 0;
            return !(((CrossProduct(c - b, p - c) >= 0) ^ clockwise) && ((CrossProduct(a - c, p - a) >= 0) ^ clockwise)) ? Inclusion.Inside : Inclusion.Outside;
        }
        ...
        public static Inclusion PolygonContainsPoint(
            List<PolygonContour2D> polygons,
            double pX, double pY,
            double epsilon = Epsilon)
        {
