...
namespace Engine
{
        ...
        : IEquatable<OrientedBoundingBox4D>
    {
        ...
        [DebuggerStepThrough]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Equals([AllowNull] OrientedBoundingBox4D other) => X == other.X && Y == other.Y && Z == other.Z && W == other.W && Height == other.Height && Width == other.Width && Depth == other.Depth && Breadth == other.Breadth;
