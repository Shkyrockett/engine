...
namespace Engine
{
        ...
        : IShapeSegment, IPropertyCaching, IEquatable<LineSegment2D>
    {
        ...
        public Polynomial CurveX
        {
            get
            {
                var curveX = (Polynomial)(this as IPropertyCaching).CachingProperty(() => Polynomials.Bezier(Points.Select(p => p.X).ToArray()));
        ...
        public Polynomial CurveY
        {
            get
            {
                var curveY = (Polynomial)(this as IPropertyCaching).CachingProperty(() => Polynomials.Bezier(Points.Select(p => p.Y).ToArray()));
