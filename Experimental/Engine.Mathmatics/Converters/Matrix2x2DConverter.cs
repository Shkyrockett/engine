// <copyright file="Matrix2x2DConverter.cs" company="Shkyrockett" >
...
{
    /// <summary>
    /// The matrix2x2D converter class.
    /// </summary>
    /// <remarks>
    /// http://referencesource.microsoft.com
    /// </remarks>
    public sealed class Matrix2x2DConverter
        : TypeConverter
    {
        /// <summary>
        ...
        {
            if (destinationType != null && value is Matrix2x2D)
            {
                var instance = (Matrix2x2D)value;
