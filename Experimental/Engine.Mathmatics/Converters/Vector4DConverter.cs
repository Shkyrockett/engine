// <copyright file="Vector4DConverter.cs" company="Shkyrockett" >
...
namespace Engine
{
    ...
    /// </summary>
    public sealed class Vector4DConverter
        : TypeConverter
    {
        /// <summary>
        ...
        {
            if (destinationType != null && value is Vector4D)
            {
                var instance = (Vector4D)value;
