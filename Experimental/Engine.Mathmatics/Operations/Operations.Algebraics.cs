...
namespace Engine
{
    ...
    public static partial class Operations
    {
        ...
        public static double Root(double x, double y)
            => (x < 0d && Math.Abs((y % 2d) - 1d) < double.Epsilon) ? -Pow(-x, 1d / y) : Pow(x, 1d / y);
        ...
        //[DebuggerStepThrough]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IList<(double X, double Y)> AlignPoints(IList<(double X, double Y)> points, double x1, double y1, double x2, double y2)
        {
