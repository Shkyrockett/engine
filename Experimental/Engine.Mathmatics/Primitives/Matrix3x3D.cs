...
namespace Engine
{
    ...
    [DebuggerDisplay("{nameof(Matrix2x2D)}({nameof(M0x0)}: {M0x0 ?? double.NaN}, {nameof(M0x1)}: {M0x1 ?? double.NaN}, {nameof(M0x2)}: {M0x2 ?? double.NaN}, {nameof(M1x0)}: {M1x0 ?? double.NaN}, {nameof(M1x1)}: {M1x1 ?? double.NaN}, {nameof(M1x2)}: {M1x2 ?? double.NaN}), {nameof(M2x0)}: {M2x0 ?? double.NaN}, {nameof(M2x1)}: {M2x1 ?? double.NaN}, {nameof(M2x2)}: {M2x2 ?? double.NaN})")]
