...
namespace MidiEventEditor
{
        ...
        : class
    {
        ...
        public TreeViewBinding(TreeView treeView,
        ...
        /// <param name="addTreeNodeFunc"></param>
        /// <param name="updateTreeNodeAction"></param>
        public TreeViewBinding(TreeNode parentTreeNode, BindingSource bindingSource, Func<object, iMidiElement> getDataItemFunc, Func<iMidiElement, TreeNode> addTreeNodeFunc, Action<iMidiElement, TreeNode> updateTreeNodeAction)
        ...
        /// <param name="addTreeNodeFunc"></param>
        /// <param name="updateTreeNodeAction"></param>
        private TreeViewBinding(TreeView treeView, TreeNodeCollection treeNodeCollection, TreeNode parentTreeNode, BindingSource bindingSource, Func<object, iMidiElement> getDataItemFunc, Func<iMidiElement, TreeNode> addTreeNodeFunc, Action<iMidiElement, TreeNode> updateTreeNodeAction)
        {
